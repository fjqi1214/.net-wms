...
namespace BenQGuru.eMES.Client
{
    ...
    /// Form1 的摘要说明。
    /// </summary>
    public class FTSInputEdit : BaseForm
    {
        private Infragistics.Win.UltraWinTabControl.UltraTabSharedControlsPage ultraTabSharedControlsPage1;
        private Infragistics.Win.UltraWinTabControl.UltraTabPageControl ultraTabPCNGQuery;
        private Infragistics.Win.UltraWinTabControl.UltraTabPageControl ultraTabPCTS;
        ...
        private UCButton ucBtnViewNGPics;
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FTSInputEdit));
            ...
            this.ultraTabPCTS = new Infragistics.Win.UltraWinTabControl.UltraTabPageControl();
            ...
            this.ucBtnViewNGPics = new UserControl.UCButton();
            ...
            this.ultraTabPCTS.SuspendLayout();
            ...
            // ultraTabPCTS
            // 
            this.ultraTabPCTS.Controls.Add(this.ultraTabTSInput);
            this.ultraTabPCTS.Controls.Add(this.groupBox2);
            this.ultraTabPCTS.Location = new System.Drawing.Point(1, 23);
            this.ultraTabPCTS.Name = "ultraTabPCTS";
            this.ultraTabPCTS.Size = new System.Drawing.Size(860, 605);
            // 
            // ultraTabTSInput
            // 
            ...
            this.groupBox2.Controls.Add(this.ucBtnViewNGPics);
            ...
            this.txtAgentUser.Location = new System.Drawing.Point(414, 16);
            ...
            // ucBtnViewNGPics
            // 
            this.ucBtnViewNGPics.BackColor = System.Drawing.SystemColors.Control;
            this.ucBtnViewNGPics.BackgroundImage = ((System.Drawing.Image)(resources.GetObject("ucBtnViewNGPics.BackgroundImage")));
            this.ucBtnViewNGPics.ButtonType = UserControl.ButtonTypes.None;
            this.ucBtnViewNGPics.Caption = "显示不良位置";
            this.ucBtnViewNGPics.Cursor = System.Windows.Forms.Cursors.Hand;
            this.ucBtnViewNGPics.Location = new System.Drawing.Point(716, 16);
            this.ucBtnViewNGPics.Name = "ucBtnViewNGPics";
            this.ucBtnViewNGPics.Size = new System.Drawing.Size(88, 22);
            this.ucBtnViewNGPics.TabIndex = 2;
            this.ucBtnViewNGPics.Visible = false;
            this.ucBtnViewNGPics.Click += new System.EventHandler(this.ucBtnViewNGPics_Click);
            // 
            // ucBtnTSErrorEdit
            // 
            ...
            this.ucBtnTSErrorEdit.Location = new System.Drawing.Point(622, 16);
            ...
            this.ultraTabCtrlTS.Controls.Add(this.ultraTabPCTS);
            ...
            ultraTab5.TabPage = this.ultraTabPCTS;
            ultraTab5.Text = "维修";
            ...
            this.ultraTabPCTS.ResumeLayout(false);
        ...
        private void ucLEMNID_TxtboxKeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
        {
            if (e.KeyChar == '\r')
            {
                ...
                InitialItem2Routes(this.ucLEMNID.Value.Trim());
                //Laws Lu,2007/01/05,新增	缓解性能问题
                ((BenQGuru.eMES.Common.DomainDataProvider.SQLDomainDataProvider)DataProvider).PersistBroker.CloseConnection();
        ...
        private BenQGuru.eMES.Domain.TS.TS getTSByRunningCard(string rcard, bool checkStatus)
        {
            ...
            BenQGuru.eMES.Domain.TS.TS ts = (BenQGuru.eMES.Domain.TS.TS)this._tsFacade.GetCardLastTSRecord(sourceRCard);
            ...
            // Added By Hi1/Venus.Feng on 20080825 for Hisense Version:Auto TS
            if (checkStatus && ts.TSStatus == TSStatus.TSStatus_New)
            {
                ...
                try
                {
                    ...
                    if (messages.IsSuccess())
                    {
                        ...
                        //Remove from carton
                        Simulation simulation = (Simulation)dataCollectFacade.GetSimulation(actionEventArgs.RunningCard.Trim().ToUpper());
                        if (simulation != null && simulation.CartonCode.Trim().Length > 0)
                        {
                    ...
                    {
                        ts = (BenQGuru.eMES.Domain.TS.TS)this._tsFacade.GetCardLastTSRecord(sourceRCard);
                        this.DataProvider.CommitTransaction();
        ...
        {
            this._currentTS = this.getTSByRunningCard(this.ucLEMNID.Value.Trim(), true);
            ...
            if (this._currentTS == null)
            {
                ...
                this.ucLEMNID.TextFocus(false, true);
                // Ian Add 2012/03/23 新增 显示"显示不良位置按钮"
                this.ucBtnViewNGPics.Visible = false;
                return;
            }

            // Ian Add 2012/03/23 新增 显示"显示不良位置按钮"
            this.ucBtnViewNGPics.Visible = true;
        ...
        private void ucBtnTSErrorEdit_Click(object sender, System.EventArgs e)
        {
            ...
            BenQGuru.eMES.Domain.TS.TS ts = this.getTSByRunningCard(this.ucLEMNID.Value.Trim(), true);
        ...
        private void InitialItem2Routes(string rcard)
        {
            ...
            {
                string sourceRCard = (new DataCollectFacade(DataProvider)).GetSourceCard(rcard.Trim().ToUpper(), string.Empty);
                object sim = (new DataCollectFacade(DataProvider)).GetSimulation(sourceRCard);
                if (sim != null)
                {
                    ...
                    if (objItem2Routes != null && objItem2Routes.Length != 0)
                    {
                    ...
                    {
                        Messages msg = new Messages();
                        //返回错误信息：产品对应的途程信息不存在，(检查ORGID)
                        msg.Add(new UserControl.Message(MessageType.Error, "$Error_Item_Route_Not_Exists"));
                        ApplicationRun.GetInfoForm().Add(msg);
                        this.ucLEMNID.TextFocus(false, true);
                    }
                }
                for (int i = 0; i < cmbRoute.ComboBoxData.Items.Count; i++)
                {
                    ...
                    if (((sim as Simulation).RouteCode) != String.Empty)
                    {
                    ...
                    else
                    {
                        ...
                        {
                            object ojbTS = _tsFacade.GetCardLastTSRecord(sourceRCard);
        ...
        private void ucBtnViewNGPics_Click(object sender, EventArgs e)
        {
            Messages msg = new Messages();
            try
            {
                if (!string.IsNullOrEmpty(this.ucLEMNID.Value))
                {
                    DataCollectFacade m_DataCollectFacade = new DataCollectFacade(this.DataProvider);
                    object objSim = m_DataCollectFacade.GetSimulation(this.ucLEMNID.Value);
                    if (objSim != null)
                    {
                        FCollectionEsopPicNGView picNGView = new FCollectionEsopPicNGView();
                        picNGView.Owner = this;
                        picNGView.Init(this.ucLEMNID.Value);
                        picNGView.ShowDialog();
                        picNGView = null;
                    }
                }
                else
