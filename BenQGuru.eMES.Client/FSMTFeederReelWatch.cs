...
namespace BenQGuru.eMES.Client
{
    ...
    /// </summary>
    public class FSMTFeederReelWatch : BaseForm
    {
        ...
        private void FSMTFeederReelWatch_Load(object sender, System.EventArgs e)
        {
            ...
            //this.InitGridLanguage(gridLineError);
        }
        ...
        private void RefreshData()
        {
            ...
            try
            {
                ...
                if (listAlertFeeder.Count > 0 || listAlertReel.Count > 0)
                {
                    //System.Threading.Thread thread = new System.Threading.Thread(new System.Threading.ThreadStart(PlayAlertMusic));
                    //thread.Start();
                    PlayAlertMusic();
                }
