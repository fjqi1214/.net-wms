...
namespace BenQGuru.eMES.FacilityFileParser
{
	...
	/// 继承自DataFileParser
	/// </summary>
	public class AOIFileParser:DataFileParser
	{
		new protected string _configFile = "AOIDataFileParser.xml";
		//new protected string _formatName = "AOIDataFileParser.xml";
		protected const int pCodePosition = 14;
		protected int iTotalColumns = 0;

		protected const string ErrorCodeSplitSymbol = ",0,0,0,";

		public AOIFileParser(IDomainDataProvider dataProvider) : base(dataProvider)
		{
		}
