...
{
    public partial class FSMTReturn : UserControl
    {
        ...
        private void txtFeederCode_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {                
                ...
                if (e.KeyChar == '\r')
                {
                    ...
                    string[] res = new CeHelper().JsonToStrs(smtLoadService.SMTReturn(Mocode, MachineCode, StationTable, ReelNo, StationCode, FeederCode, usercode, rescode, stationTableGroupActive));
        ...
        private void FSMTReturn_Resize(object sender, EventArgs e)
        {
            this.txtMocode.Focus();
            this.txtMocode.SelectAll();
        }
