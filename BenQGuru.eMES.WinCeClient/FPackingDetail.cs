...
{
    public partial class FPackingDetail : UserControl
    {
        ...
        public FPackingDetail(string pickNo, string carInvNo, Form parent)
        {
            if (parent == null)
            {
            ...
            dt = this._PackagingOperationsService.GetDataGrid2(pickNo);
            BindDataGrid(dt);
