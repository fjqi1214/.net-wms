...
{
    public partial class FSMTChangeReal : UserControl
    {
        ...
        private void txtReelNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                if (e.KeyChar == '\r')
                {
                    ...
                    string[] res = new CeHelper().JsonToStrs(smtLoadService.SMTChangeReal(Mocode, MachineCode, StationTable,OldReelNo, ReelNo, StationCode, usercode, rescode, stationTableGroupActive));
        ...
        private void FSMTChangeReal_Resize(object sender, EventArgs e)
        {
            this.txtMocode.Focus();
            this.txtMocode.SelectAll();
        }
