...
{
    public partial class FSMTCheck : UserControl
    {
        ...
        private void txtReelNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                ...
                if (e.KeyChar == '\r')
                {
                    ...
                    string[] res = new CeHelper().JsonToStrs(smtLoadService.SMTCheck(Mocode, MachineCode, StationTable, ReelNo, StationCode, usercode, rescode));
        ...
        private void FSMTCheck_Resize(object sender, EventArgs e)
        {
            this.txtMocode.Focus();
            this.txtMocode.SelectAll();
        }
