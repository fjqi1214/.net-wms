...
{
    public partial class FSMTExchanges : UserControl
    {
        ...
        private void txtReelNo_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                if (e.KeyChar == '\r')
                {
                    ...
                    this.txtOldFeederCode.Focus();
                    this.txtOldFeederCode.SelectAll();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void txtOldFeederCode_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                if (e.KeyChar == '\r')
                {
                    if (this.txtOldFeederCode.Text.Trim() == string.Empty)
                    {
                        this.txtmessage.Text = "请输入料卷编号";
                        return;
                    }
        ...
        private void txtFeederCode_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                if (e.KeyChar == '\r')
                {
                    ...
                    string OldFeederCode = this.txtOldFeederCode.Text.Trim().ToUpper();
                    ...
                    {
                        this.txtmessage.Text = "请输入原有Feeder代码";
                        this.txtOldFeederCode.Focus();
                        this.txtOldFeederCode.SelectAll();
                        return;
                    }
                    ...
                    string[] res = new CeHelper().JsonToStrs(smtLoadService.SMTExchanges(Mocode, MachineCode, StationTable,OldReelNo, ReelNo, StationCode,OldFeederCode, FeederCode, usercode, rescode, stationTableGroupActive));
                    ...
                    else
                    {
                        ...
                        else if (message.Contains("Old_FeederCode"))
                        {
                            this.txtOldFeederCode.Focus();
                            this.txtOldFeederCode.SelectAll();
                        }
        ...
        private void FSMTExchanges_Resize(object sender, EventArgs e)
        {
            this.txtMocode.Focus();
            this.txtMocode.SelectAll();
        }
