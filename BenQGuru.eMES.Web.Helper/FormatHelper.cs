...
namespace BenQGuru.eMES.Web.Helper
{
    ...
    public class FormatHelper : MarshalByRefObject
    {
        ...
        //根据代码获取中文名称 add by jinger 20160308
        /// <summary>
        /// 根据代码获取中文名称
        /// </summary>
        /// <param name="Code">代码</param>
        /// <returns></returns>
        public static string GetChName(string Code)
        {
            ...
            switch (Code)
            {
                ...
                case "ExemptCheck":
                    chName = "免检";
                    break;
                case "item_control_keyparts":
                    chName = "单件管控";
                    break;
                case "item_control_lot":
                    chName = "批管控";
                    break;
                case "item_control_nocontrol":
                    chName = "不管控";
                    break;
                case "单件管控":
                    chName = "item_control_keyparts";
                    break;
                case "批管控":
                    chName = "item_control_lot";
                    break;
                case "不管控":
                    chName = "item_control_nocontrol";
                    break;
                default:
                    chName = Code;
                    break;
