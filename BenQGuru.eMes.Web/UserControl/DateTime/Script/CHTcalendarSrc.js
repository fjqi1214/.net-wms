...
function getHtmlFile()
{
	...
	htmlStr=htmlStr+"/UserControl/DateTime/Script/CHTCalendar1Frame.htm"
	return htmlStr;
}

function calendar1(t, enable)
{
	...
	var sPath =getHtmlFile()// "../../Script/CHTCalendar1Frame.htm";
	var sTemp="";
	var strReturnValue;
	...
	//sDate = open	(sPath,sTemp,strFeatures);
	//
	//alert('change'+sDate);
...
function calendarCell(t)
{
	...
	//var sPath = "../../function/CHTCalendar1Frame.htm";
