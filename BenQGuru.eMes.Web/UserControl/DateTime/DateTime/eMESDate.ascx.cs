namespace BenQGuru.eMES.Web.UserControl
{
	...
	///		ucDate 的摘要说明。
	/// </summary>
	public partial class eMESDate : System.Web.UI.UserControl
	{
		...
		public string GetCalendarJsFileUrl()
		{
            ...
            if (sessionHelper.Language == "CHS")
            {
                return GetBaseUrl() + "UserControl/DateTime/Script/CHScalendarSrc.js";
            }
            if (sessionHelper.Language == "CHT")
            {
                return GetBaseUrl() + "UserControl/DateTime/Script/CHTcalendarSrc.js";
            }
            if (sessionHelper.Language == "ENU")
            {
                return GetBaseUrl() + "UserControl/DateTime/Script/ENUcalendarSrc.js";
            }
            return GetBaseUrl() + "UserControl/DateTime/Script/CHScalendarSrc.js";
		}
