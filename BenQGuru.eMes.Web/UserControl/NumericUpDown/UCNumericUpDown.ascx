<%@ Control Language="c#" AutoEventWireup="false" Codebehind="UCNumericUpDown.ascx.cs" Inherits="BenQGuru.eMES.Web.UserControl.UCNumericUpDown" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
