...
<body ms_positioning="GridLayout">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">返工途程维护</asp:Label>
                ...
                <table class="edit" id="Table4" height="100%" cellpadding="0" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblReworkCode" runat="server">需求单号</asp:Label>
                        </td>
                        <td class="fieldValue">
                        ...
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblRoute" runat="server">途程</asp:Label>
                        </td>
                        <td class="fieldValue">
