...
<body scroll="yes">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">返工来源维护</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblReworkSourceCodeQuery" runat="server">返工来源代码</asp:Label>
                        </td>
                        <td class="fieldValue">
        ...
        <tr class="normal">
            <td>
                <table class="edit" height="100%" cellpadding="0" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblReworkSourceCodeEdit" runat="server">返工来源代码</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtReworkSourceCodeEdit" runat="server" CssClass="require"></asp:TextBox>
                        </td>
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblReworkDescriptionEdit" runat="server">返工来源描述</asp:Label>
                        </td>
                        <td class="fieldValue">
