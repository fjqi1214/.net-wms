...
<body ms_positioning="GridLayout">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">返工签核</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblApproverQuery" runat="server">签核人员</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtReworkApproverQuery" CssClass="textbox" runat="server" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblPassSequenceQuery" runat="server">签核状态</asp:Label>
                        </td>
                        <td class="fieldValue">
        ...
        <tr class="normal">
            <td>
                <table class="edit" height="100%" cellpadding="0" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblApproveContentEdit" runat="server">签核意见</asp:Label>
                        </td>
                        <td class="fieldValue">
        ...
        <tr class="toolBar">
            <td>
                <table class="toolBar">
                    <tr>
                        <td class="toolBar">
                            <input class="submitImgButton" id="cmdPass" type="submit" value="通 过" name="cmdPass"
                                runat="server" onserverclick="cmdPass_ServerClick">
                        </td>
                        <td class="toolBar">
                            <input class="submitImgButton" id="cmdNoPass" type="submit" value="不通过" name="cmdNoPass"
                        ...
                        <td class="toolBar">
                            <input class="submitImgButton" id="cmdCancel" type="submit" value="取 消" name="cmdSave"
