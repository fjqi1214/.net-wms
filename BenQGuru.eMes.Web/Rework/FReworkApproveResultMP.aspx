<%@ Page Language="c#" CodeBehind="FReworkApproveResultMP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.Rework.FReworkApproveResultMP" %>
...
<body>
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">签核信息</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
