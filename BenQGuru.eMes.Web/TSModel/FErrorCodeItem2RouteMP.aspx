<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FErrorCodeItem2RouteMP.aspx.cs" Inherits="BenQGuru.eMES.Web.FErrorCodeItem2RouteMP" %>
...
<head>
    <title>FErrorCodeItem2Route</title>
    ...
    <form id="form1" runat="server">
        <table height="100%" width="100%">
			<tr class="moduleTitle">
				<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic">不良代码返工途程维护</asp:label></td>
			</tr>
			<tr>
				<td>
					<table class="query" height="100%" width="100%">
						<tr>
							<td class="fieldNameLeft" noWrap><asp:label id="lblNGCodeQuery" runat="server">不良代码</asp:label></td>
							<td class="fieldValue"><asp:TextBox id="txtErrorCodeQuery" ReadOnly="true" runat="server" CssClass="textbox"></asp:TextBox></td>
							<td class="fieldNameLeft" noWrap><asp:label id="lblItemCodeQuery" runat="server">产品代码</asp:label></td>
							<td class="fieldValue"><asp:TextBox id="txtItemCodeQuery" runat="server" CssClass="textbox"></asp:TextBox></td>
			...
			<tr class="normal">
				<td>
					<table class="edit" height="100%" cellPadding="0" width="100%">
						<tr>
							<td class="fieldNameLeft" style="HEIGHT: 26px" noWrap><asp:label id="lblItemCodeEdit" runat="server">产品代码</asp:label></td>
						    <td class="fieldValue" style="HEIGHT: 26px"><cc2:selectabletextbox id="txtItemCodeEdit" runat="server" Type="singleitem" Target=""></cc2:selectabletextbox></td>
						    <td class="fieldNameLeft" style="HEIGHT: 26px" noWrap>
						        <asp:Label ID="lblResourceReworkRouteCode" runat="server">返工途程</asp:Label>
						    </td>
						    <td class="fieldValue" style="HEIGHT: 26px">
						        <cc2:selectabletextbox id="txtReworkRoute" runat="server" Type="singleroute" Target=""></cc2:selectabletextbox>
						    </td>
						</tr>
						<tr>
						    <td class="fieldNameLeft" style="HEIGHT: 26px" noWrap>
						    ...
						    <td class="fieldValue" style="HEIGHT: 26px">
						        <cc2:selectabletextbox id="txtOPCodeEdit" runat="server" Type="singleop" Target=""></cc2:selectabletextbox>
						    </td>
						</tr>
					</table>
				</td>
