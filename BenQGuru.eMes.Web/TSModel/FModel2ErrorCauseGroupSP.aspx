...
<%@ Page Language="c#" CodeBehind="FModel2ErrorCauseGroupSP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.TSModel.FModel2ErrorCauseGroupSP" %>
...
<head>
    ...
    <script language="javascript">
        function RedictURL() {
            ...
            var result = window.showModalDialog("FModel2ErrorCauseGroupAP.aspx?Modelcode=" + escape(modelCode), arg, "dialogWidth:800px;dialogHeight:600px;scroll:none;help:no;status:no");
...
<body topmargin="0" ms_positioning="GridLayout">
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 不良原因组列表</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblErrorCauseGroupQuery" runat="server" Visible="False"> 不良原因组代码</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 159px">
