<%@ Page language="c#" Codebehind="FModel2ErrorCauseAP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.TSModel.FModel2ErrorCauseAP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 选择不良原因</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								<td class="fieldNameLeft" noWrap><asp:label id="lblErrorCauseCodeQuery" runat="server"> 不良原因代码</asp:label></td>
								<td class="fieldValue" style="WIDTH: 159px"><asp:textbox id="txtErrorCauseCodeQuery" runat="server" Width="150px" CssClass="textbox"></asp:textbox></td>
								<td class="fieldNameLeft" noWrap><asp:label id="lblModelCodeQuery" runat="server" Visible="False"> 产品别代码</asp:label></td>
