<%@ Page language="c#" Codebehind="FModel2ErrorCauseSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.TSModel.FModel2ErrorCauseSP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 不良原因列表</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								...
								<td class="fieldName" noWrap><asp:label id="lblErrorCauseCodeQuery" runat="server" Visible="False"> 不良原因代码</asp:label></td>
								<td class="fieldValue" style="WIDTH: 159px"><asp:textbox id="txtErrorCauseCodeQuery" runat="server" Width="150px" CssClass="textbox" Visible="False"></asp:textbox></td>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
				...
				<tr class="toolBar">
					<td>
						<table class="toolBar">
							<tr>
								<td class="toolBar"><INPUT class="submitImgButton" id="cmdAdd" type="submit" value="新 增" name="cmdAdd" runat="server" onserverclick="cmdSelect_ServerClick"></td>
