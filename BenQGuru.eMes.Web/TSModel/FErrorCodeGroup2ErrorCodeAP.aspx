<%@ Page Language="c#" CodeBehind="FErrorCodeGroup2ErrorCodeAP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.TSModel.FErrorCodeGroup2ErrorCodeAP" %>
...
<body topmargin="0" ms_positioning="GridLayout">
    ...
    <table height="100%" width="100%" id="table1" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 选择不良代码</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblSummaryObjectQuery" runat="server" Visible="False"> 不良代码组</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 159px">
