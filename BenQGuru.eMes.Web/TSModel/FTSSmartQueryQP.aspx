...
<%@ Page language="c#" Codebehind="FTSSmartQueryQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.TSModel.FTSSmartQueryQP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTSSmartQueryTitle" runat="server" CssClass="labeltopic">智能维修设置查询</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								...
								<td class="fieldValue"><asp:TextBox id="txtErrorCodeQuery" runat="server" CssClass="textbox" ReadOnly="true"></asp:TextBox></td>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
				...
				<tr class="toolBar">
					<td>
						<table class="toolBar">
							<tr>
								<td><INPUT class="submitImgButton" id="cmdReturn" type="submit" value="返 回" name="cmdReturn" runat="server" ></td>
							</tr>
						</table>
					</td>
				</tr>
