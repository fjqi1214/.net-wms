<%@ Page Language="c#" CodeBehind="FModel2SolutionSP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.TSModel.FModel2SolutionSP" %>
...
<head>
    ...
    <script language="javascript">
        function RedictURL() {
            ...
            var result = window.showModalDialog("FModel2SolutionAP.aspx?Modelcode=" + escape(modelCode), arg, "dialogWidth:800px;dialogHeight:600px;scroll:none;help:no;status:no");
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td style="height: 19px">
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 解决方案列表</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap style="display: none">
                            <asp:Label ID="lblSolutionCodeQuery" runat="server" Visible="False"> 解决方案代码</asp:Label>
                        </td>
                        <td class="fieldValue" style="display: none">
                            <asp:TextBox ID="txtSolutionCodeQuery" runat="server" Width="150px" CssClass="textbox"
