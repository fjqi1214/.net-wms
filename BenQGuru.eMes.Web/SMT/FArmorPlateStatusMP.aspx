...
<%@ Page Language="c#" CodeBehind="FArmorPlateStatusMP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.SMT.FArmorPlateStatusMP" %>
...
<html>
<head>
    <title>FArmorPlateStatusMP</title>
    ...
    <script language="javascript">
        function CheckEnter() {
            if (event.keyCode == 13) {
                //document.getElementById('txtMenoEdit').focus();
        ...
        function Init() {
            if (document.all.txtAPIDEdit.value != "") {
                if (document.all.txtCurStatusEdit.value != "") {
                    document.getElementById("txtMenoEdit").focus();
                }
                else {
            ...
            <td>
                <table class="edit" height="100%" cellpadding="0" width="100%">
                    <tr>
                        ...
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                            <asp:Label ID="lblCurStatusEdit" runat="server">当前状态</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtCurStatusEdit" runat="server" CssClass="require" Width="130px"
                    ...
                    <tr>
                        ...
                        <td class="fieldValue" nowrap colspan="3">
        ...
        <tr class="toolBar">
            <td>
                <table class="toolBar">
                    <tr>
                        <td class="toolBar">
                            <input class="submitImgButton" id="cmdStartEnd" type="submit" value="启用/停用" name="cmdStartEnd"
                                runat="server">
                        </td>
