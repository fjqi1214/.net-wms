<%@ Page language="c#" Codebehind="FSMTMachineDiscardImpSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SMT.FSMTMachineDiscardImpSP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 设备抛料资料导入</asp:label></td>
				</tr>
				<tr>
					<td>
