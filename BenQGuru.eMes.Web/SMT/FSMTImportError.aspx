<%@ Page language="c#" Codebehind="FSMTImportError.aspx.cs" AutoEventWireup="false" Inherits="BenQGuru.eMES.Web.SMT.FSMTImportError" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr >
					<td><asp:label id="lblTitles" runat="server" CssClass="labeltopic"> 导入错误信息</asp:label></td>
				</tr>
