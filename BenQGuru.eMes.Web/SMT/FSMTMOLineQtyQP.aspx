...
<%@ Page Language="c#" CodeBehind="FSMTMOLineQtyQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.SMT.FSMTMOLineQtyQP" %>
...
<body ms_positioning="GridLayout" scroll="yes">
    <form id="Form1" method="post" runat="server" runat="server">
    <table height="100%" width="100%">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">工单SMT产量查询</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
