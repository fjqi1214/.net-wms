...
<%@ Page language="c#" Codebehind="FSMTImport.aspx.cs" AutoEventWireup="false" Inherits="BenQGuru.eMES.Web.SMT.FSMTImport" %>
	...
	<HEAD>
		...
		<script language="jscript">
			...
			function CheckIfCopy()
			{
				...
				if(document.all.txtMOCode.value == '' || document.all.txtMOCode.value == '0')
				{
					alert("请选择待维护工单");
					return false;
				}
			...
			{
				OnCheckBom();
				document.all.txtMOCode.focus();
			}
			function OnKeyPress()
			{
				if('txtMOCode'== event.srcElement.name  && 13 == window.event.keyCode )
				{
					//document.all.cmdPending.click();
					...
					<TR>
						<TD style="PADDING-LEFT: 8px; HEIGHT: 20px">
							<TABLE class="query" id="Table13" cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR>
									<TD class="fieldName" noWrap><FONT face="宋体"><asp:label id="lblMOCode" runat="server">   工单代码</asp:label></FONT></TD>
									<TD noWrap><asp:textbox id="txtMOCode" runat="server" CssClass="textbox" Width="120px"></asp:textbox><input type="hidden" id="hidtxtMOCode" runat="server"></TD>
									<TD class="toolBar"><INPUT class="submitImgButton" id="cmdPending" type="submit" value="选择工单" name="cmdPending"
											runat="server"></TD>
						...
						<TD style="PADDING-LEFT: 8px; HEIGHT: 20px">
							<TABLE class="query" cellSpacing="0" cellPadding="0" width="100%">
								...
								<tr id="compareSourceTR">
									...
									<td colspan="2"><asp:RadioButtonList id="rblMOBOMSourceSelect" runat="server" RepeatDirection="Horizontal" AutoPostBack="True"></asp:RadioButtonList></td>
								</tr>
								<TR id="compareBomTR">
									<td colspan="2">
										<table>
												...
												<TR>
													<TD vAlign="top" align="left">
														<TABLE class="edit" id="Table9" height="100" cellSpacing="0" cellPadding="0" width="100%"
															...
															<TR>
																<TD style="PADDING-RIGHT: 8px" vAlign="top"><ignav:ultrawebtree id="treeWebTree" runat="server" Width="100%" HiliteClass="HiliteClass" Indentation="20"
																		ExpandImage="ig_treePlus.gif" CollapseImage="ig_treeMinus.gif" DisabledClass="DisabledClass" JavaScriptFilename="/ig_scripts2/ig_webtree2.js"
																		ImageDirectory="/ig_Images2/" WebTreeTarget="ClassicTree" Cursor="hand" Height="100%" Font-Size="12px">
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
			...
			</TD></TR></TBODY></TABLE> <input type="hidden" id="hidComparesource" runat="server">
		</form>
	</body>
</HTML>
