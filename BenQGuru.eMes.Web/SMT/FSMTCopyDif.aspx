			...
			<table height="100%" width="100%">
					...
					<td>
						<table  cellPadding="0" width="100%">
							...
							<tr class="moduleTitle" valign=top height=30px>
								<td><asp:label id="Label1" runat="server" CssClass="labeltopic">(钩选表示覆盖)</asp:label></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr class="normal" style="DISPLAY: none" valign=top>
					<td>
						<table height="100%" cellPadding="0" width="100%">
							<tr>
								<td><FONT face="宋体"><asp:checkbox id="chbSelectAll" runat="server" Width="124px" Text="全选"></asp:checkbox></FONT></td>
								<td width="100%"></td>
							</tr>
						</table>
					</td>
				...
				<tr class="toolBar" valign=baseline height="20%">
					<td>
						<table class="toolBar">
							<tr>
								<td class="toolBar"><INPUT class="submitImgButton" id="cmdCopy" type="submit" value="覆 盖" name="cmdCopy" runat="server"></td>
								<td><INPUT class="submitImgButton" id="cmdReturn" type="button" value="返 回" name="cmdReturn" onclick="Close();"
										runat="server"></td>
							</tr>
						</table>
					</td>
