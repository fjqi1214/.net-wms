...
<body ms_positioning="GridLayout">
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 锡膏登记</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblLotSNQuery" runat="server">锡膏批号</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                    ...
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblDateStartQuery" runat="server"> 生产日期起</asp:Label>
                        </td>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblZ" runat="server"> 至</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 159px">
        ...
        <tr class="normal">
            <td>
                <table class="edit" height="100%" cellpadding="0" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblSPIDEdit" runat="server"> 锡膏编码</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblLotSNEdit" runat="server">锡膏批号</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
