<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRptViewDataSourceColumn.aspx.cs"
    Inherits="BenQGuru.eMES.Web.ReportView.FRptViewDataSourceColumn" %>
...
<body ms_positioning="GridLayout">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">数据源栏位定义</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblDllName" runat="server">数据源</asp:Label>
                        </td>
                        <td class="fieldNameLeft" nowrap>
        ...
        <tr class="toolBar">
            <td>
                <table class="toolBar">
                    <tr>
                        <td class="toolBar">
                            <input class="submitImgButton" id="cmdSure" type="submit" value="确 定" name="cmdSure"
