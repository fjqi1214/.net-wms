<%@ Page Language="c#" CodeBehind="FRptUploadStep1MP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.ReportView.FRptUploadStep1MP" %>
...
<body ms_positioning="GridLayout" scroll="yes">
    ...
    <table height="100%" width="100%" id="tableMain">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">报表上传 1/4 －－ 上传报表文件</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <table>
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblUploadRptFileName" runat="server">报表文件</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <input type="file" id="fileRpt" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td class="fieldNameLeft" nowrap>
