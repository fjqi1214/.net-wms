<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRptViewDataSource.aspx.cs"
    Inherits="BenQGuru.eMES.Web.ReportView.FRptViewDataSource" %>
...
<body ms_positioning="GridLayout">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">数据源定义</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td nowrap width="100%">
                            <td class="fieldName" style="height: 15px; width: 213px;">
                ...
                <table class="edit" height="100%" cellpadding="0" width="100%">
                    <tr>
                        ...
                        <td class="fieldName" nowrap style="height: 31px">
                            <asp:Label ID="lblDataSourceEdit" runat="server">数据库</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 31px">
                    ...
                    <tr>
                        <td class="fieldNameLeft" style="height: 26px; width: 75px;" nowrap valign="top">
                            <asp:Label ID="lblserverType" runat="server" Width="80px">类型</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 26px" valign="top">
                            <asp:DropDownList ID="drpdbtype" runat="server" CssClass="require" Width="130px">
                                <asp:ListItem>Sql语句</asp:ListItem>
                                <asp:ListItem>DLL文件</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td class="fieldName" nowrap valign="top">
                            <asp:Label ID="lblDBEdit" runat="server">数据源</asp:Label>
                        </td>
                        <td colspan="3" class="fieldValue">
                            <asp:TextBox ID="txtDBDefaultNameEdit" runat="server" CssClass="require" Width="365px"
