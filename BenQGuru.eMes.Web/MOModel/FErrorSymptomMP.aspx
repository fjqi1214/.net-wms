<%@ Page language="c#" Codebehind="FErrorSymptomMP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.MOModel.FErrorSymptomMP" %>
<%@ Register TagPrefix="igtbl" Namespace="Infragistics.WebUI.UltraWebGrid" Assembly="Infragistics35.WebUI.UltraWebGrid.v11.1, Version=11.1.20111.1006, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" %>
<%@ Register TagPrefix="cc1" Namespace="BenQGuru.eMES.Web.Helper" Assembly="BenQGuru.eMES.WebUI.Helper" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>FErrorSymptomMP</title>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 不良现象维护</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								<td class="fieldNameLeft" noWrap><asp:label id="lblSymptomCodeQuery" runat="server"> 不良现象</asp:label></td>
								<td class="fieldValue"><asp:textbox id="txtSymptomCodeQuery" runat="server" CssClass="textbox" Width="130px"></asp:textbox></td>
								<td width="100%"></td>
				...
				<tr class="normal">
					<td>
						<table class="edit" height="100%" cellPadding="0" width="100%">
							<tr>
								<td class="fieldName" style="HEIGHT: 26px" noWrap><asp:label id="lblSymptomEdit" runat="server">不良现象</asp:label></td>
								<TD class="fieldValue" style="HEIGHT: 26px"><asp:textbox id="txtSymptomEdit" runat="server" CssClass="require" Width="130px"></asp:textbox></TD>
								<td class="fieldName" style="HEIGHT: 26px" noWrap><asp:label id="lblDescEdit" runat="server">描述</asp:label></td>
								<TD class="fieldValue" style="HEIGHT: 26px"><asp:textbox id="txtDescEdit" runat="server" CssClass="textbox" Width="130px"></asp:textbox></TD>
								<td width="100%" nowrap>
								</td>
							</tr>
						</table>
