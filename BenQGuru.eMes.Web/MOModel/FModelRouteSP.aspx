...
<%@ Page language="c#" Codebehind="FModelRouteSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.MOModel.FModelRouteSP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 选择生产途程</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								<td class="fieldName" noWrap><asp:label id="lblRouteCodeQuery" runat="server">生产途程代码</asp:label></td>
								<td class="fieldValue"><asp:textbox id="txtRouteCodeQuery" runat="server" CssClass="textbox" Width="150px"></asp:textbox></td>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
				...
				<tr class="toolBar">
					<td>
						<table class="toolBar">
							<tr>
								<td class="toolBar"><INPUT class="submitImgButton" id="cmdAdd" type="submit" value="选 择" name="cmdAdd" runat="server" onserverclick="cmdAdd_ServerClick"></td>
