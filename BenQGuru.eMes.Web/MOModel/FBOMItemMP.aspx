...
<body ms_positioning="GridLayout">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 物料清单料品信息</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblItemName" runat="server"> 产品名称</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtItemName" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblItemType" runat="server"> 产品类型</asp:Label>
                        </td>
                        <td class="fieldValue">
