...
<body ms_positioning="GridLayout">
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> SPC测试项维护</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <table class="edit" height="100%" cellpadding="0" width="100%">
                    <tr>
                        ...
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                            <asp:Label ID="lblObjectNameEdit" runat="server">项目名称</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 26px">
                            <asp:TextBox ID="txtObjectNameEdit" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                            <asp:Label ID="lblGraphTypeEdit" runat="server">图表类型</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 26px">
                        ...
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                            <asp:Label ID="lblDateEdit" runat="server">日期范围</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 26px">
