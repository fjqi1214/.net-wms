...
{
    public partial class FMOConfirmMP : BenQGuru.eMES.Web.Helper.BasePage
    {
        ...
        {
            return this._MOFacade.GetMO2SAPList(this.txtMoCodeQuery.Text.Trim().ToUpper(), 0, int.MaxValue);
        }
        ...
        private MO2SAP GetMO2SAP()
        {
            ...
            mo2sap.MOProduced = decimal.Parse(this.txtConfirmQtyEdit.Text.Trim());
