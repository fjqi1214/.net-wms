<%@ Page language="c#" Codebehind="FOutDataImport.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.OutSourcing.FOutDataImport" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 料站表资料导入</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								<td class="fieldNameLeft" noWrap><asp:label id="lblImportType" runat="server"> 导入类型</asp:label></td>
								<td class="fieldValue" style="WIDTH: 159px">
									<asp:DropDownList Runat="server" ID="ddlImportType" AutoPostBack="True" onselectedindexchanged="ddlImportType_SelectedIndexChanged">
										<asp:ListItem Value=""></asp:ListItem>
										<asp:ListItem Value="OutMO_Lot" Selected="True">Lot主资料</asp:ListItem>
										<asp:ListItem Value="OutWIP_Lot">Lot生产过程</asp:ListItem>
										<asp:ListItem Value="OutWIPMaterial_Lot">Lot关键部料</asp:ListItem>
										<asp:ListItem Value="OutMO_Piece">Piece工单资料</asp:ListItem>
										<asp:ListItem Value="OutWIP_Piece">Piece生产过程</asp:ListItem>
										<asp:ListItem Value="OutWIPMaterial_Piece">Piece关键部料</asp:ListItem>
									</asp:DropDownList>
								</td>
