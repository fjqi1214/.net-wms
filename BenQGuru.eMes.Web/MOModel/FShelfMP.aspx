...
<%@ Page language="c#" Codebehind="FShelfMP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.MOModel.FShelfMP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 车号维护</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								<td class="fieldNameLeft" noWrap><asp:label id="lblShelfNOQuery" runat="server"> 车号</asp:label></td>
								<td class="fieldValue"><asp:textbox id="txtShelfNOQuery" runat="server" CssClass="textbox" Width="120px"></asp:textbox></td>
								<td width="100%"></td>
				...
				<tr class="normal">
					<td>
						<table class="edit" height="100%" cellPadding="0" width="100%">
							<tr>
								<td class="fieldNameLeft" style="HEIGHT: 26px" noWrap><asp:label id="lblShelfNOEdit" runat="server">车号</asp:label></td>
								<td class="fieldValue" style="HEIGHT: 26px"><asp:textbox id="txtShelfNOEdit" runat="server" CssClass="require" Width="130px" MaxLength="6"></asp:textbox></td>
								<td class="fieldName" style="HEIGHT: 26px" noWrap><asp:label id="lblMemoEdit" runat="server">备注</asp:label></td>
								<TD class="fieldValue" style="HEIGHT: 26px"><asp:textbox id="txtMemoEdit" runat="server" CssClass="textbox" Width="130px"></asp:textbox></TD>
								<td width="100%"></td>
							</tr>
						</table>
					</td>
