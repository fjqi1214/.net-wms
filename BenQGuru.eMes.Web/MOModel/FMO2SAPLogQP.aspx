<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMO2SAPLogQP.aspx.cs" Inherits="BenQGuru.eMES.Web.MOModel.FMO2SAPLogQP" %>
<%@ Register TagPrefix="igtbl" Namespace="Infragistics.WebUI.UltraWebGrid" Assembly="Infragistics35.WebUI.UltraWebGrid.v11.1, Version=11.1.20111.1006, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" %>
<%@ Register TagPrefix="cc1" Namespace="BenQGuru.eMES.Web.Helper" Assembly="BenQGuru.eMES.WebUI.Helper" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>FMO2SAPLogQP</title>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic">报工错误信息</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								...
								<td class="fieldValue" style="WIDTH: 159px">
								    <asp:textbox id="txtMoCodeQuery" runat="server" Width="150px" ReadOnly="True" CssClass="textbox"></asp:textbox>
								</td>
								<td class="fieldNameLeft" noWrap><asp:label id="lblPostSeq" runat="server">报工批次</asp:label></td>
								<td class="fieldValue" style="WIDTH: 159px">
								    <asp:textbox id="txtPostSeqQuery" runat="server" Width="150px" ReadOnly="True" CssClass="textbox"></asp:textbox>
								</td>
