		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 工序物料清单维护</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								...
								<td class="fieldName" style="HEIGHT: 26px" noWrap><asp:label id="lblBOMCodeQuery" runat="server">料品清单代码</asp:label></td>
					...
					<td>
						<table class="edit" height="100%" cellPadding="0" width="100%">
							<tr>
								...
								<td class="fieldName" style="HEIGHT: 26px" noWrap><asp:label id="lblOPBOMCodeEdit" runat="server">料品清单代码</asp:label></td>
								...
								<TD class="fieldName" noWrap><asp:label id="lblRouteCodeEdit" runat="server">途程代码</asp:label></TD>
								<td class="fieldValue">
