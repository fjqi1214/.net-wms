...
<%@ Page language="c#" Codebehind="FModelRouteEP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.MOModel.FModelRouteEP" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>FModelRouteEP</title>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 产品别途程维护</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								...
								<td class="fieldValue">
									<asp:textbox id="txtModelCodeQuery" runat="server" CssClass="textbox" Width="150px" ReadOnly="True"></asp:textbox></td>
