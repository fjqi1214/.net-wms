		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblFSetCustProTitle" runat="server" CssClass="labeltopic">客户组产品维护</asp:label></td>
				</tr>
				<tr>
					<td>
				...
				<tr height="100%">
					<td class="fieldGrid"><FONT face="宋体"><igtbl:ultrawebgrid id="gridWebGrid" runat="server" Width="100%" Height="100%">
				...
				<tr class="normal">
					<td>
						<table class="edit" height="100%" cellPadding="0" width="100%">
							<tr>
								<td class="fieldNameLeft" noWrap><asp:label id="lblCustomGroupCodeEdit" runat="server">客户组代码</asp:label></td>
								...
								<td class="fieldName" noWrap><asp:label id="lblItemTypeEdit" runat="server">产品类别</asp:label></td>
								<td class="fieldValue"><asp:textbox id="citemtype" runat="server" CssClass="textbox"></asp:textbox></td>
								<td class="fieldNameLeft" noWrap><asp:label id="lblItemDescEdit" runat="server">产品描述</asp:label></td>
