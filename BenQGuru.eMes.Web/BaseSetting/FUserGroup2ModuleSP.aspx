...
<%@ Page language="c#" Codebehind="FUserGroup2ModuleSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.BaseSetting.FUserGroup2ModuleSP" %>
				...
				<tr class="normal">
					<td>
						<table class="edit" height="100%" cellPadding="0" width="100%">
							<tr>
								<td class="fieldNameLeft" noWrap><asp:label id="lblModuleCodeEdit" runat="server"> 模块代码</asp:label></td>
								<td class="fieldValue" style="WIDTH: 159px"><asp:textbox id="txtModuleCodeEdit" runat="server" Width="150px" CssClass="textbox" ReadOnly="True"></asp:textbox></td>
								<td class="fieldName" noWrap><asp:CheckBoxList id="chbRight" runat="server" Width="304px" RepeatDirection="Horizontal">
										<asp:ListItem Value="8">导出权限</asp:ListItem>
										<asp:ListItem Value="4">读权限</asp:ListItem>
										<asp:ListItem Value="2">写权限</asp:ListItem>
										<asp:ListItem Value="1">删除权限</asp:ListItem>
									</asp:CheckBoxList></td>
