...
<body ms_positioning="GridLayout">
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblSAPTitle" runat="server" CssClass="labeltopic">SAP关账周期维护</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lbldateFromQuery" runat="server">创建日期</asp:Label>
                        </td>
                        <td >
            ...
            <td>
                <table class="edit" height="100%" cellpadding="0" width="100%">
                    <tr>
                        ...
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblFromDateTimeEdit" runat="server">开始日期</asp:Label>
                        </td>
                        <td class="fieldValue">
                           <asp:TextBox type="text" id="txtDateUseEdit"  class='datepicker' runat="server"  Width="130px"/>
                        </td>
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblOnTimeEdit" runat="server">开始时间</asp:Label>
                        </td>
                        <td class="fieldValue">
                        ...
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblEndDateTimeEdit" runat="server">结束日期</asp:Label>
                        </td>
                        <td class="fieldValue">
                         ...
                         <td class="fieldName" nowrap>
                            <asp:Label ID="lblOffTimeEdit" runat="server">结束时间</asp:Label>
                        </td>
                        <td class="fieldValue">
