<%@ Page Language="c#" CodeBehind="FUserGroup2VendorSP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.BaseSetting.FUserGroup2VendorSP" %>
...
<head>
    ...
    <script language="javascript">
        function RedictURL() {
            var usergroupcode = document.getElementById("txtUserGroupCodeQuery").value;
            var arg = new Object();
            arg.Others = usergroupcode;
            var result = window.showModalDialog("FUserGroup2VendorAP.aspx?usergroupcode=" + escape(usergroupcode), arg, "dialogWidth:800px;dialogHeight:600px;scroll:none;help:no;status:no");
...
<body ms_positioning="GridLayout">
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 供应商列表</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblVendorSN" runat="server">供应商代码</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtVendorCodeQuery" runat="server" CssClass="textbox"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                        </td>
                        <td class="fieldName">
