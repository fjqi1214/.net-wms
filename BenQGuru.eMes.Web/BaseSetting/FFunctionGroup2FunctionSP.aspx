...
<%@ Page language="c#" Codebehind="FFunctionGroup2FunctionSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.BaseSetting.FFunctionGroup2FunctionSP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 选择功能</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								<td class="fieldNameLeft" noWrap><asp:label id="lblFunctionGroupCodeQuery" runat="server"> 功能组代码</asp:label></td>
								<td><asp:textbox id="txtFunctionGroupCodeQuery" runat="server" Width="90px" ReadOnly="True" CssClass="textbox"></asp:textbox></td>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
								...
								<ImageUrls ImageDirectory="../Skin/ig_Images/"></ImageUrls>
