...
{
	/// <summary>
	/// FUserGroup2ResourceAP 的摘要说明。
	/// </summary>
	public partial class FUserGroup2ResourceAP : BaseAPageNew
	{
		...
		protected override void AddDomainObject(ArrayList domainObjects)
		{
			if(facade==null)
			{
				facade = new SystemSettingFacadeFactory(base.DataProvider).CreateUserFacade() ;
			}
			facade.AddUserGroup2Resource( (UserGroup2Resource[])domainObjects.ToArray(typeof(UserGroup2Resource)));
		}
		...
		protected override int GetRowCount()
		{
			...
			return this.facade.GetUnselectedResourceByUserGroupCodeCount( 
		...
		protected override object[] LoadDataSource(int inclusive, int exclusive)
		{
			...
			return this.facade.GetUnselectedResourceByUserGroupCode( 
				FormatHelper.PKCapitalFormat(FormatHelper.CleanString(this.txtUserGroupCodeQuery.Text)),
				FormatHelper.PKCapitalFormat(FormatHelper.CleanString(this.txtResourceCodeQuery.Text)),
				inclusive,exclusive);
		}
		...
		{
			this.Response.Redirect(this.MakeRedirectUrl("./FUserGroup2ResourceSP.aspx", new string[]{"usergroupcode"}, new string[]{this.txtUserGroupCodeQuery.Text}));
		}
		#endregion
