<%@ Page Language="c#" CodeBehind="FDCTResourceSP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.BaseSetting.FDCTResourceSP" %>
...
<head>
    ...
    <script language="javascript">
        function RedictURL() {
            var dctCode = document.getElementById("txtDctCommandQuery").value;
            var arg = new Object();
            arg.Others = dctCode;
            var result = window.showModalDialog("FDCTResourceAP.aspx?dctCode=" + escape(dctCode), arg, "dialogWidth:800px;dialogHeight:600px;scroll:none;help:no;status:no");
                ...
                <table class="query" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblDctCommandQuery" runat="server"> DCT指令代码</asp:Label>
                        </td>
