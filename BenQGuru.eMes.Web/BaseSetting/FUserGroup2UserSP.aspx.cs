...
namespace BenQGuru.eMES.Web.BaseSetting
{
    ...
    /// </summary>
    public partial class FUserGroup2UserSP : BaseMPageNew
    {
        ...
        {
            //UserGridColumnBuilder gridBuilder = new UserGridColumnBuilder(this.gridWebGrid);
            base.InitWebGrid();
            //gridBuilder.BuildForSelectPage();
        ...
        protected override int GetRowCount()
        {
            ...
            return this.facade.GetSelectedUserByUserGroupCodeCount(
        ...
        protected override object[] LoadDataSource(int inclusive, int exclusive)
        {
            ...
            return facade.GetSelectedUserAndOrgIDByUserGroupCode(
                FormatHelper.PKCapitalFormat(FormatHelper.CleanString(this.txtUserGroupCodeQuery.Text)),
                FormatHelper.PKCapitalFormat(FormatHelper.CleanString(this.txtUserCodeQuery.Text)),
                inclusive, exclusive);
        }
        ...
        {
            this.Response.Redirect(this.MakeRedirectUrl("./FUserGroup2UserAP.aspx", new string[] { "usergroupcode" }, new string[] { this.txtUserGroupCodeQuery.Text.Trim() }));
        }
