...
{
    /// <summary>
    /// FFunctionGroup2FunctionSP 的摘要说明。
    /// </summary>
    public partial class FFunctionGroup2FunctionSP : BaseMPage
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                this.txtFunctionGroupCodeQuery.Text = this.GetRequestParam("functiongroupcode");
            }
        ...
        private void AddExpandColumn(string key, string text)
        {
            ...
            this.gridWebGrid.Bands[0].Columns.FromKey(key).CellStyle.BackgroundImage = System.AppDomain.CurrentDomain.BaseDirectory + "skin/image/Expand.gif";
                //this.VirtualHostRoot + "skin/image/Expand.gif";
            ...
            this.gridWebGrid.Bands[0].Columns.FromKey(key).CellButtonStyle.BackgroundImage = System.AppDomain.CurrentDomain.BaseDirectory + "skin/image/Expand.gif";
                //this.VirtualHostRoot + "skin/image/Expand.gif";
        ...
        {
            this.Response.Redirect(this.MakeRedirectUrl("./FFunctionGroupMP.aspx"));
        }
        #endregion
        ...
        private string GetQueryParameterModuleParent()
        {
            ...
            else
            {
                ...
                string strRet = facade.GetQueryParentList(this.drpModuleTypeEdit.SelectedValue, this.txtModuleCodeQuery.Text.Trim().ToUpper(), this.txtModuleDescEdit.Text.Trim().ToUpper(), this.txtModuleFormURLQuery.Text.Trim().ToUpper(), this.chkShowExistModule.Checked.ToString(), this.txtFunctionGroupCodeQuery.Text);
        ...
        protected void FFunctionGroup2FunctionSP_PreRender(object sender, EventArgs e)
        {
            this.cmdSave.Disabled = false;
        }
        protected override void cmdSave_Click(object sender, EventArgs e)
        {
            ...
            facade.UpdateSelectModuleInFunctionGroup(
                FormatHelper.PKCapitalFormat(FormatHelper.CleanString(this.txtFunctionGroupCodeQuery.Text)),
