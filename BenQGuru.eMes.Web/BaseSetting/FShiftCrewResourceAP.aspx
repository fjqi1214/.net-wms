<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FShiftCrewResourceAP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.BaseSetting.FShiftCrewResourceAP" %>
...
<body ms_positioning="GridLayout">
    ...
    <table height="100%" width="100%" runat="server" id="table1">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">新增资源</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblCrewCodeQuery" runat="server" Visible="False"> 班组代码</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 159px">
                            <asp:TextBox ID="txtCrewCodeQuery" runat="server" Width="150px" ReadOnly="True" CssClass="textbox"
