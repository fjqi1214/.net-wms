...
<%@ Page language="c#" Codebehind="FItemCheck.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.BaseSetting.FItemCheck" %>
<%@ Register TagPrefix="cc1" Namespace="BenQGuru.eMES.Web.Helper" Assembly="BenQGuru.eMES.WebUI.Helper" %>
<%@ Register TagPrefix="igtbl" Namespace="Infragistics.WebUI.UltraWebGrid" Assembly="Infragistics35.WebUI.UltraWebGrid.v11.1, Version=11.1.20111.1006, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>FItemCheck</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" height="100%" width="100%">
				<TR class="moduleTitle">
					<TD>
						<asp:Label id="lblTitle" runat="server">产品资料检查</asp:Label></TD>
				</TR>
				<TR>
					<TD>
						<TABLE class="query" id="Table2">
							<TBODY>
								<TR>
									...
									<td class="fieldValue">
										<cc2:selectabletextbox id="txtItemQuery" runat="server" Width="100" Type="item"></cc2:selectabletextbox>
									</td>
					</TD>
