<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FEQPMaintainLogAdd.aspx.cs"
    Inherits="BenQGuru.eMES.Web.BaseSetting.FEQPMaintainLogAdd" %>
...
<html>
<head>
    <title>FEQPMaintainLogAdd</title>
...
<body ms_positioning="GridLayout">
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">保养日志维护新增页面</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
