<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FShiftCrewResourceSP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.BaseSetting.FShiftCrewResourceSP" %>
...
<html>
<head>
    <title>FShiftCrewResourceSP</title>
    ...
    <script language="javascript">
        function RedictURL() {
            var crewCode = document.getElementById("txtCrewCodeQuery").value;
            var arg = new Object();
            arg.Others = crewCode;
            var result = window.showModalDialog("FShiftCrewResourceAP.aspx?crewCode=" + escape(crewCode), arg, "dialogWidth:800px;dialogHeight:600px;scroll:none;help:no;status:no");
                ...
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue" style="width: 159px">
                            <asp:TextBox ID="txtCrewCodeQuery" runat="server" Width="150px" ReadOnly="True" CssClass="textbox"></asp:TextBox>
                        </td>
