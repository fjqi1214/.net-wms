...
namespace BenQGuru.eMES.Web.BaseSetting.ImportIndirectManCountDate
{
    public partial class FExcelDataImp : BaseMPageMinus
    {
        ...
        protected override void InitWebGrid()
        {
            ...
            ArrayList htable = this.XmlHelper.GetGridBuilder();
            if (htable.Count > 0)
            {
        ...
        private void RequestData()
        {
            ...
            //    //GridRecord row = new Infragistics.WebUI.UltraWebGrid.UltraGridRow(objs);
            //    //this.gridHelper.Grid.Rows.Add(row);
            //}
            this.gridHelper.Grid.DataSource = dt;
            this.gridHelper.Grid.DataBind();
            this.lblCount.Text = dt.Rows.Count.ToString();
        }

        protected void cmdReturn_ServerClick(object sender, EventArgs e)
        {
            if (InputType == "IndirectManCount")
            {
                this.Response.Redirect(this.MakeRedirectUrl("../FIndirectManCountMP.aspx"));
            }
            else
            {
                this.Response.Redirect(this.MakeRedirectUrl("../FLine2CrewMP.aspx"));
            }
        }
        ...
        protected void cmdAdd_ServerClick(object sender, EventArgs e)
        {
            ...
            ImportIndirectManCountDate.ImportManCountDateEngine importEngine = new BenQGuru.eMES.Web.BaseSetting.ImportIndirectManCountDate.ImportManCountDateEngine(
                base.DataProvider, languageComponent1, this.InputType, dt, this.GetUserCode(), importArray,gridHelper.CheckColumnKey);
