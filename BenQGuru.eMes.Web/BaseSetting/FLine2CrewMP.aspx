...
<%@ Page Language="c#" CodeBehind="FLine2CrewMP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.BaseSetting.FLine2CrewMP" %>
                ...
                <table class="edit" height="100%" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <asp:TextBox type="text" id="DateEdit"  class='datepicker' runat="server"  Width="130px"/>
                        ...
                        <td class="fieldValue" style="height: 26px; width: 211px;">
                            <asp:TextBox ID="txtSSEdit" runat="server" CssClass="require" Width="110px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblShiftCodeEdit" runat="server">班次代码</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 130px">
                            <cc2:SelectableTextBox ID="txtShiftCodeEdit" runat="server" Type="singleshiftcode"
                        ...
                        <td class="fieldValue" style="width: 130px">
                            <cc2:SelectableTextBox ID="txtCrewCodeEdit" runat="server" Type="singlecrewcode"
                                CssClass="require" CanKeyIn="True"></cc2:SelectableTextBox>
                        </td>
                    </tr>
                </table>
