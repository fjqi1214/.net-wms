...
<%@ Page Language="c#" CodeBehind="FUserGroup2FunctionGroupAP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.BaseSetting.FUserGroup2FunctionGroupAP" %>
            ...
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue" style="width: 159px">
                            <asp:TextBox ID="txtFunctionGroupCodeQuery" runat="server" Width="150px" CssClass="textbox"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                        </td>
                        <td class="fieldName">
