            ...
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblDocnumQuery" runat="server">文件编号</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 120px">
                    ...
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblKeywordQuery" runat="server">关键字</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 120px">
                    ...
                    <tr>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblCheckedStatusQuery" runat="server">审核状态</asp:Label>
                        </td>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblValidStatusQuery" runat="server">有效状态</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
