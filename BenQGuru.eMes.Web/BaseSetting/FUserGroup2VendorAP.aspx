...
<%@ Page Language="c#" CodeBehind="FUserGroup2VendorAP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.BaseSetting.FUserGroup2VendorAP" %>
...
<body ms_positioning="GridLayout">
    ...
    <table width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 选择供应商</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
