<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FDatabaseChangePage.aspx.cs" Inherits="BenQuru.eMES.Web.FDatabaseChangePage" %>
    ...
    <table id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
        ...
        <tr class="edit">
            <td style="margin-left:10px;">
                <asp:RadioButtonList CssClass="radiobuttonlist" runat="server" ID="RadioButtonListDatabase" RepeatDirection="Vertical" RepeatLayout="Table">
                </asp:RadioButtonList>
