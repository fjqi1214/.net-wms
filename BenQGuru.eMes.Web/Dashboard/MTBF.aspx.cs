...
namespace BenQGuru.eMES.Web.Dashboard
{
	...
	/// MTBF 的摘要说明。
	/// </summary>
	public partial class MTBF : System.Web.UI.Page
	{
		...
		public void GetMTBF()
		{
			...
			if(this.Request.QueryString["sscode"] != null)
			{
				ssCode = this.Request.QueryString["sscode"];
			}
			...
			string xmlContent = dbFAC.getMTBF(
				modelCode
				,itemCode
				,ssCode
				,frmDate
