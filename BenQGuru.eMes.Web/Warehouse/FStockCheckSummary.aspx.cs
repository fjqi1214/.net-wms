...
{
    public partial class FStockCheckSummary : BaseMPageNew
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                InitWebGrid();
                this.drpCheckType.Items.Add(new ListItem(string.Empty, string.Empty));
        ...
        protected override void InitWebGrid()
        {
            ...
            this.gridHelper.AddColumn("CHECKCOUNT", "盘点次数", null);
            this.gridHelper.AddColumn("PASSREAT", "盘点准确率", null);
        ...
        protected override DataRow GetGridRow(object obj)
        {
            ...
            CheckSummary s = (CheckSummary)obj;
            row["STORAGECODE"] = s.StorageCode;
            row["CHECKCOUNT"] = s.CHECKNOTOTAL;
            if (s.TOTAL > 0)
                row["PASSREAT"] = Math.Round((double)s.PASSCOUNT / s.TOTAL, 2) * 100 + "%";
            else
                row["PASSREAT"] = string.Empty;
            return row;
        }
        ...
        protected override object[] LoadDataSource(int inclusive, int exclusive)
        {
            ...
            return this.facade.QueryStockCheckSummarys(txtWWPoSerialEdit.Text.Length > 0 ? txtWWPoSerialEdit.Text.Split(',') : new string[0], drpCheckType.SelectedValue, FormatHelper.TODateInt(dateInDateFromQuery.Text),
