<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FProductOutStorageRecord.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FProductOutStorageRecord" %>
                ...
                <table class="query" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblProjectNameQuery" runat="server">项目名称</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 159px">
                            <asp:TextBox ID="txtProjectNameQuery" runat="server" Width="150px" DESIGNTIMEDRAGDROP="257"
                                CssClass="textbox"></asp:TextBox>
                        </td>
                         <td><asp:Label ID="lblORDERNOQuery1" runat="server">合同号</asp:Label>
                        </td>
                        <td> <asp:TextBox ID="txtORDERNOQuery" runat="server" Width="150px" DESIGNTIMEDRAGDROP="257"
                                CssClass="textbox"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                   ...
                   <tr>
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtSNQuery" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>
                         <td class="fieldName" nowrap>
                            <asp:Label ID="lblSupplierLotNoQuery" runat="server">供应商批次号</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtSupplierLotNoQuery" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>
                        
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblCustOrderQuery" runat="server">客户订单号</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 159px">
                            <asp:TextBox ID="txtCustOrderQuery" runat="server" Width="150px" DESIGNTIMEDRAGDROP="257"
                                CssClass="textbox"></asp:TextBox>
                        </td>
                        <td></td>
                        <td></td>
