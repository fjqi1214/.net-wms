<%@ Page Language="c#" CodeBehind="FSAPInvoicesSoftwareMP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.Warehouse.FSAPInvoicesSoftwareMP" %>
...
<html>
<head>
    <title>FSAPInvoicesSoftwareMP</title>
...
<body>
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblFSAPInvoicesSoftwareMP" runat="server" CssClass="labeltopic">纯软件出库</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
