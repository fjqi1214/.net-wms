...
<%@ Page language="c#" Codebehind="FWHCycleAdjMP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FWHCycleAdjMP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 库存调整</asp:label></td>
				</tr>
				<tr>
					<td>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
				...
				<tr class="normal">
					<td align="center">
						<table class="edit" height="100%" cellPadding="0" width="100%">
							<tr>
								<td nowrap width="100%"> <input type="hidden" id="txtFactoryCode" runat="server" NAME="txtFactoryCode">
				...
				<tr class="toolBar">
					<td>
						<table class="toolBar">
							<tr>
								<td class="toolBar"><INPUT class="submitImgButton" id="cmdAdjust" type="submit" value="调整" name="cmdComfirm"
