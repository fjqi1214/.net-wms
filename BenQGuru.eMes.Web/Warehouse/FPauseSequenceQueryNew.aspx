<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FPauseSequenceQueryNew.aspx.cs"
    Inherits="BenQGuru.eMES.Web.WarehouseWeb.FPauseSequenceQueryNew" %>
...
<body ms_positioning="GridLayout">
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">停发序列号查询</asp:Label>
            </td>
        </tr>
        <tr>
