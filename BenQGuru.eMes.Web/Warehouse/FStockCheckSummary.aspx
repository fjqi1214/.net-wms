<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FStockCheckSummary.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FStockCheckSummary" %>
                    ...
                    <tr>
                        ...
                        <td class="fieldValue" nowrap>
                           <cc2:SelectableTextBox ID="txtWWPoSerialEdit" runat="server" CssClass="require"
                               Type="StorageCode" Target="FStorageCodes.aspx"  AutoPostBack ="true"  width="10px"  ></cc2:SelectableTextBox>                             
