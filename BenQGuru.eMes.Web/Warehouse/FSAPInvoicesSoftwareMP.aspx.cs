...
namespace BenQGuru.eMES.Web.Warehouse
{
    ...
    /// </summary>
    public partial class FSAPInvoicesSoftwareMP : BaseMPageNew
    {
        ...
        protected override void InitWebGrid()
        {
            ...
            //this.gridHelper.AddColumn("DNBatchNo", "DN批次号", null);
            //this.gridHelper.AddColumn("INVSTATUS", "头状态", null);
            //this.gridHelper.AddColumn("INVLINE", "行项目号", null);
            //this.gridHelper.AddColumn("INVLINESTATUS", "行状态", null);
            //this.gridHelper.AddColumn("PRNO", "PR号", null);
            //this.gridHelper.AddColumn("DQMCODE", "鼎桥物料编码", null);
            //this.gridHelper.AddColumn("PLANQTY", "数量", null);
            //this.gridHelper.AddColumn("UNIT", "单位", null);
            //this.gridHelper.AddColumn("CUSBATCHNO", "客户批次号/项目名称", null);
            //this.gridHelper.AddColumn("ORDERNO", "合同号", null);
            //this.gridHelper.AddColumn("CUSORDERNO", "订单号", null);
            //this.gridHelper.AddColumn("OANO", "OA流水号", null);
            //this.gridHelper.AddColumn("REWORKAPPLYUSER", "检测返工申请人", null);
            //this.gridHelper.AddColumn("CC", "预留单成本中心", null);
            //this.gridHelper.AddColumn("INVENTORYNO", "盘点凭证号", null);
            //this.gridHelper.AddColumn("RECEIVERUSER", "联系人及联系方式 （预留）", null);
            ////this.gridHelper.AddColumn("RECEIVERUSER", "收货联系人及联系方式 （UB）", null);
            //this.gridHelper.AddColumn("SHIPPINGLOCATION", "收货地址(DN)", null);
            //this.gridHelper.AddColumn("RECEIVERADDR", "入库库位地址(UB)", null);
            ////this.gridHelper.AddColumn("RECEIVERADDR", "收货/发货地址(预留)", null);
            //this.gridHelper.AddColumn("REMARK1", "备注（盘点调整）", null);
            ////this.gridHelper.AddColumn("REMARK1", "备注（UB）", null);
            //this.gridHelper.AddColumn("GFFLAG", "是否硬件光伏", null);
            //this.gridHelper.AddColumn("MOVEMENTTYPE", "移动类型", null);
            //this.gridHelper.AddColumn("FACCODE", "工厂", null);
            //this.gridHelper.AddColumn("FROMSTORAGECODE", "出库库位", null);
            //this.gridHelper.AddColumn("STORAGECODE", "入库库位", null);
            //this.gridHelper.AddColumn("GFHWMCODE", "光伏华为编码", null);
            //this.gridHelper.AddColumn("GFPACKINGSEQ", "光伏包装序号", null);
            //this.gridHelper.AddColumn("CUSMCODE", "客户物料编码", null);
            //this.gridHelper.AddColumn("CUSITEMSPEC", "客户物料型号", null);
            //this.gridHelper.AddColumn("CUSITEMDESC", "客户物料描述", null);
            //this.gridHelper.AddColumn("VENDERMCODE", "供应商物料编码", null);
            //this.gridHelper.AddColumn("GFHWDESC", "光伏华为描述", null);
            //this.gridHelper.AddColumn("HWCODEQTY", "华为编码数量", null);
            //this.gridHelper.AddColumn("HWCODEUNIT", "华为编码数量单位", null);
            //this.gridHelper.AddColumn("HWTYPEINFO", "华为型号标签信息", null);
            ...
            //this.gridHelper.AddColumn("HIGNLEVELITEM", "上层行项目号", null);
            //this.gridHelper.AddColumn("PACKINGWAY", "包装方式", null);
            //this.gridHelper.AddColumn("PACKINGNO", "包装箱编号", null);
            //this.gridHelper.AddColumn("PACKINGSPEC", "包装箱规格", null);
            //this.gridHelper.AddColumn("PACKINGWAYNO", "包装箱方式取数", null);
            //this.gridHelper.AddColumn("PLANGIDATE", "计划交货日期", null);
            //this.gridHelper.AddColumn("NEEDDATE", "希望到货日期（预留）", null);
            //this.gridHelper.AddColumn("DEMANDARRIVALDATE", "要求到货时间（UB）", null);
            //this.gridHelper.AddColumn("VENDORMCODE", "供应商物料编码", null);
            //this.gridHelper.AddColumn("CUSTMCODE", "华为物料编码(UB)", null);
            //this.gridHelper.AddColumn("RECEIVEMCODE", "收货方物料编码(UB)", null);

            //this.gridHelper.AddColumn("GFCONTRACTNO", "光伏合同号", null);
            //this.gridHelper.AddColumn("CUSORDERNOTYPE", "订单类型", null);
            //this.gridHelper.AddColumn("ORDERREASON", "订单原因", null);
            //this.gridHelper.AddColumn("POSTWAY", "交付方式", null);
            //this.gridHelper.AddColumn("PICKCONDITION", "拣料条件", null);
        ...
        protected override object[] LoadDataSource(int inclusive, int exclusive)
        {
            ...
            return this.facade.QuerySAPInvoicesQuery(
        ...
        protected override object GetEditObject(GridRecord row)
        {
           ...
           string invno= row.Items.FindItemByKey("INVNO").Text;
           string invline= row.Items.FindItemByKey("INVLINE").Text;

           object obj = facade.QuerySAPInvoicesDetail(invno, invline);
            if (obj != null)
            {
                return obj;
            }
        ...
        protected void cmdSoftwareOut_ServerClick(object sender, EventArgs e)
        {
            ...
            if (array.Count > 0)
            {
             ...
             sapInvoicesList = ((SAPInvoicesQuery[])objList.ToArray(typeof(SAPInvoicesQuery)));
            }
            else
            {
                WebInfoPublish.Publish(this, "请选择一条数据", this.languageComponent1); 
                return;
            }
            ...
            try
            {
                ...
                #region 出库
                #region dnBatchNo
                foreach (SAPInvoicesQuery invs in sapInvoicesList)
                {
                    string dnBatchNo = invs.DNNO; 
                    string movementtype = invs.MOVEMENTTYPE;
