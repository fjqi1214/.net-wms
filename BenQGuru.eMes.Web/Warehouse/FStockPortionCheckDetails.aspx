<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FStockPortionCheckDetails.aspx.cs"
    Inherits="BenQGuru.eMES.Web.WarehouseWeb.FStockPortionCheckDetails" %>
            ...
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblLocationCodeQuery" runat="server">货位</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:DropDownList ID="drpLocationCodeQuery" name="drpLocationCodeQuery" AutoPostBack="false"
