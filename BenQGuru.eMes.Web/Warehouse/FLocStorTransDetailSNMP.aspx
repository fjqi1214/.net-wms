<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FLocStorTransDetailSNMP.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FLocStorTransDetailSNMP" %>
...
<html>
<head>
    <title>FLocStorTransDetailMP</title>
                ...
                <table class="query" height="100%" width="100%">
                    <tr>
                         <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblLocationNoQuery" runat="server">货位移动单号SN</asp:Label>
                        </td>
