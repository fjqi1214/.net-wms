<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FPickDoneSNDetail.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FPickDoneSNDetail" %>
...
<body ms_positioning="GridLayout">
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblPickDoneSN" runat="server" CssClass="labeltopic">拣料作业SN详情</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
