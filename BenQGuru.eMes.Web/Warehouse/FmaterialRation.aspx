		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic">配料</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
							<tr>
								<td class="fieldName" noWrap><asp:label id="lblPlanDateFrom" runat="server">计划日期从</asp:label></td>
								...
								<td class="fieldNameLeft" noWrap style="width: 67px"><asp:label id="lblBigSSCodeGroup" runat="server">大线</asp:label></td>
								<td class="fieldValue">
								...
								<td class="fieldNameLeft" noWrap><asp:label id="lblActionStatusQuery" runat="server">执行状态</asp:label></td>
								...
								<td class="fieldNameLeft" noWrap style="width: 67px"><asp:label id="lblMaterialStatusQuery" runat="server">配料状态</asp:label></td>
				...
				<tr class="normal">
					<td>
						<table class="edit" height="100%" cellPadding="0" width="100%">
							<tr>
								<td class="fieldNameLeft" noWrap style="height: 29px"><asp:label id="lblDate" runat="server">日期</asp:label></td>
								...
								<td class="fieldName" noWrap style="height: 29px"><asp:label id="lblBigSSCodeGroupRequired" runat="server">大线</asp:label></td>
								...
								<td class="fieldNameLeft" style="height: 29px"><asp:label id="lblMOCodeGroup" runat="server">工单</asp:label></td>
							...
							<tr>
								<td class="fieldNameLeft" noWrap><asp:label id="lblMOSeqEdit" runat="server">工单项次</asp:label></td>
								<td class="fieldValue"><asp:TextBox id="txtMOSeqEdit" CssClass="require" runat="server" width="130px" ReadOnly=true></asp:TextBox></td>
								<td class="fieldName" noWrap><asp:label id="lblPromiseTimeEdit" runat="server">承诺配送时间</asp:label></td>
				...
				<tr class="toolBar">
					<td>
						<table class="toolBar">
							<tr>
								<td class="toolBar">
								<INPUT class="submitImgButton" id="cmdOKSuit" type="submit" value="物料齐套确认" name="cmdOKSuit" runat="server" onserverclick="cmdOKSuit_ServerClick"></td>
								<td class="toolBar"><INPUT class="submitImgButton" id="cmdCancelSuit" type="submit" value="取消齐套" name="cmdCancelSuit" runat="server" onserverclick="cmdCancelSuit_ServerClick"></td>
