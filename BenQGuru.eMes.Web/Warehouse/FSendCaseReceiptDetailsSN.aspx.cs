...
{
    public partial class FSendCaseReceiptDetailsSN : BaseMPageNew
    {
        ...
        protected override void InitWebGrid()
        {
            ...
            this.gridHelper.AddColumn("SN", "SN号", null);

            this.gridHelper.AddDefaultColumn(true, false);
            this.gridWebGrid.Columns.FromKey("QTY").Hidden = true;
            //多语言
        ...
        protected override object[] LoadDataSource(int inclusive, int exclusive)
        {
            ...
            return this._WarehouseFacade.QueryPackageReceiptsDetailsSN(txtCARINVNOQuery.Text, txtPickNoQuery.Text, txtCARTONNOQuery.Text, txtDQMCODEQuery.Text, inclusive, exclusive);
        ...
        protected override int GetRowCount()
        {
            ...
            return this._WarehouseFacade.QueryPackageReceiptsDetailsSNCount(txtCARINVNOQuery.Text, txtPickNoQuery.Text, txtCARTONNOQuery.Text, txtDQMCODEQuery.Text);
