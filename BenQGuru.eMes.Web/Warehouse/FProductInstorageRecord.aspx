<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FProductInstorageRecord.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FProductInstorageRecord" %>
                   ...
                   <tr>
                    <td class="fieldNameLeft" nowrap>
                        ...
                        <td class="fieldValue" nowrap>
                         ...
                         <td class="fieldName" nowrap>
                            <asp:Label ID="lblSupplierLotNoQuery" runat="server">SN</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
