<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRecordOQCMP.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FRecordOQCMP" %>
...
<body ms_positioning="GridLayout">
    ...
    <table id="table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblFRecordOQCMP" runat="server" CssClass="labeltopic">OQC明细报表</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
