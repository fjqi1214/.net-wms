...
{
    public partial class FPauseSequenceQuery : BaseMPageNew
    {
        ...
        protected override DataRow GetGridRow(object obj)
        {
            ...
            row["StorageCodeNew"] = ((PauseQuery)obj).GetDisplayText("StorageCode");
        ...
        {
            this.Response.Redirect(this.MakeRedirectUrl("./FPauseDetailsQuery.aspx"));
        }
