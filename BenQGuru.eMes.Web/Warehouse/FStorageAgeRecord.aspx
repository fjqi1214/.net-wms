<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FStorageAgeRecord.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FStorageAgeRecord" %>
                ...
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldName" nowrap>
                             <asp:Label ID="Label1" runat="server">物料编码</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                         ...
                         <td class="fieldName" nowrap>
                             <asp:Label ID="Label2" runat="server">鼎桥物料编码</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblCDateQuery" runat="server">起算日期</asp:Label>
                        </td>
                        <td class="fieldValue">
