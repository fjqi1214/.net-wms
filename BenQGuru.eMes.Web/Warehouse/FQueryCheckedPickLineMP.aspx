<%@ Page Language="c#" CodeBehind="FQueryCheckedPickLineMP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.Warehouse.FQueryCheckedPickLineMP" %>
...
<html>
<head>
    <title>FQueryCheckedPickLineMP</title>
            ...
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblPickLineQuery" runat="server">拣货任务令行号</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtPickLineQuery" runat="server" CssClass="require" Width="130px" ReadOnly="True"></asp:TextBox>
                        </td>
