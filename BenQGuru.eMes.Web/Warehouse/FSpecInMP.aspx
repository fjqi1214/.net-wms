<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSpecInMP.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FSpecInMP" %>
...
<head>
    ...
    <style type="text/css">
        #cmdNew
        {
           background-image:url(/TD/Skin/Image/buttonblue-2013.gif);
            }
         #cmdNew:hover
         {
             background-image:url(/TD/Skin/Image/ButtonGray-2013.gif);
             }
    </style>
</head>
<body ms_positioning="GridLayout">
    ...
    <table id="table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">入库单维护</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <table class="edit" height="100%" cellpadding="0" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue" style="height: 26px">
                            <asp:TextBox ID="txtMaterialNO" runat="server" CssClass="require" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldValue" style="height: 26px">
                     ...
                     <tr>
                        ...
                        <td class="fieldValue" style="height: 26px">
                             <input class="submitImgButton" id="cmdNew" type="submit" value="新 建" name="cmdNew"
                                runat="server" onserverclick="cmdNew_ServerClick"  />
                        </td>
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                     ...
                     <tr>
                        ...
                        <td class="fieldValue" style="height: 26px">
                             <asp:DropDownList ID="drpStorageInEdit" runat="server" AutoPostBack="true" 
                                 CssClass="require" Width="120px"
                                DESIGNTIMEDRAGDROP="94" 
                                 onselectedindexchanged="drpStorageInEdit_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td></td>
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                            <asp:Label ID="lblLoationInEdit" runat="server">入库货位</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 26px">
                             <asp:DropDownList ID="drpLoationInEdit" runat="server" CssClass="require" Width="120px"
                                DESIGNTIMEDRAGDROP="94">
                            </asp:DropDownList>
                        </td>
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
