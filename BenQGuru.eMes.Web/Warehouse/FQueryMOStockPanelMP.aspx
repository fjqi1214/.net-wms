		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 工单用量看板</asp:label></td>
				</tr>
				<tr>
					<td>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
				...
				<tr class="normal">
					<td>
						<table class="edit" height="100%" cellPadding="0" width="100%">
							<tr>
								<td class="fieldName" style="HEIGHT: 26px" noWrap><asp:label id="lblMOCodeEdit" runat="server">工单代码</asp:label></td>
								...
								<td class="fieldNameLeft" style="HEIGHT: 26px" noWrap><asp:label id="lblItemIDEdit" runat="server">物料代码</asp:label></td>
							...
							<tr>
								<td class="fieldNameLeft" style="HEIGHT: 26px" noWrap><asp:label id="lblMOAdviseQty" runat="server">建议发放数</asp:label></td>
				...
				<tr class="toolBar">
					<td>
						<table class="toolBar">
							<tr>
								<td class="toolBar"><INPUT class="submitImgButton" id="cmdAdd" type="submit" value="新 增" name="cmdAdd" runat="server"
