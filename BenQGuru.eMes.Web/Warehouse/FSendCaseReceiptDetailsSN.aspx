<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSendCaseReceiptDetailsSN.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FSendCaseReceiptDetailsSN" %>
...
<body>
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">发货箱单明细SN</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtCARINVNOQuery" runat="server" CssClass="require" Width="130px"
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtPickNoQuery" runat="server" CssClass="textbox" Width="130px"
                                Enabled="false"></asp:TextBox>
                        </td>
                        <td class="fieldName" nowrap>
                        ...
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblGFHWITEMCODEQuery" runat="server">华为物料编码</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
