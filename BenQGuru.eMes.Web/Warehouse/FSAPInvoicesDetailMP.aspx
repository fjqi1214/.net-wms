<%@ Page Language="c#" CodeBehind="FSAPInvoicesDetailMP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.Warehouse.FSAPInvoicesDetailMP" %>
...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SelectViewField() {
            var result = window.showModalDialog("FViewFieldEP.aspx?defaultUserCode=INVOICESDETAIL_FIELD_LIST_SYSTEM_DEFAULT&table=TBLINVOICESDETAIL", "", "dialogWidth:800px;dialogHeight:600px;scroll:none;help:no;status:no");
            if (result == "OK") {
                ...
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtInvNoQuery" runat="server" CssClass="require" Width="130px"  ReadOnly="True"></asp:TextBox>
                        </td>
