...
{
    public partial class FIQCExecBuyer : BaseMPageNew
    {
        ...
        protected override void InitWebGrid()
        {
            ...
            this.gridHelper.AddColumn("NGPER", "缺陷率", null);
        ...
        protected override object[] LoadDataSource(int inclusive, int exclusive)
        {
            ...
            return this.facade.GetIQCExecBuyerSummary(
        ...
        protected override int GetRowCount()
        {
            ...
            return this.facade.GetIQCExecBuyerSummaryCount(
                                        FormatHelper.TODateInt(dateInDateFromQuery.Text),
                                         FormatHelper.TODateInt(dateInDateToQuery.Text),
                                        txtDQMCodeQuery.Text,
                                        txtDQMDESCQuery.Text,
