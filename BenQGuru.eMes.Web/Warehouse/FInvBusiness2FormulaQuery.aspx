<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FInvBusiness2FormulaQuery.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FInvBusiness2FormulaQuery" %>
<%@ Register TagPrefix="igtbl" Namespace="Infragistics.WebUI.UltraWebGrid" Assembly="Infragistics35.WebUI.UltraWebGrid.v11.1, Version=11.1.20111.1006, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" %>
<%@ Register TagPrefix="cc1" Namespace="BenQGuru.eMES.Web.Helper" Assembly="BenQGuru.eMES.WebUI.Helper" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>FInvBusiness2FormulaQuery</title>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic">规则列表</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								<td class="fieldNameLeft" noWrap><asp:label id="lblBusinessCodeQuery" runat="server">业务类型代码</asp:label></td>
								<td class="fieldValue" style="WIDTH: 159px">
								    <asp:textbox id="txtBusinessCodeQuery" runat="server" Width="150px" ReadOnly="True" CssClass="textbox"></asp:textbox>
								</td>
								<td class="fieldNameLeft" noWrap><asp:label id="lblBusinessDescriptionQuery" runat="server">业务类型描述</asp:label></td>
								<td class="fieldValue" style="WIDTH: 159px">
								    <asp:textbox id="txtBusinessDescriptionQuery" runat="server" Width="250px" ReadOnly="True" CssClass="textbox"></asp:textbox>
								</td>
