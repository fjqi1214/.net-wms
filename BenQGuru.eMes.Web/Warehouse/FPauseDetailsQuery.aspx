...
<body ms_positioning="GridLayout">
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">停发明细查询</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblCancleSequenceCodeQuery" runat="server">解除编号</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 159px">
                ...
                <table class="edit" height="100%" cellpadding="0" width="100%">
                    <tr>
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                            <asp:Label ID="lblPauseReasonEdit" runat="server">停发原因</asp:Label>
                        </td>
                    ...
                    <tr>
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                            <asp:Label ID="lblPauseUserEdit" runat="server">停发人</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 26px">
                    ...
                    <tr>
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                            <asp:Label ID="lblPauseDateEdit" runat="server">停发日期</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 26px">
