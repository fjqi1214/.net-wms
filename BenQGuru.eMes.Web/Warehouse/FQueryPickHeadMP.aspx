<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FQueryPickHeadMP.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FQueryPickHeadMP" %>
...
<body ms_positioning="GridLayout">
    ...
    <table id="table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">查询拣货任务令头界面</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <asp:CheckBox ID="chbReleaseQuery" runat="server" Text="Release" type="checkbox"   ></asp:CheckBox>
            <asp:CheckBox ID="chbWaitPickQuery" runat="server" Text="WaitPick" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbPickQuery" runat="server" Text="Pick" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbMakePackingListQuery" runat="server" Text="MakePackingList" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbPackQuery" runat="server" Text="Pack" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbOQCQuery" runat="server" Text="OQC" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbClosePackingListQuery" runat="server" Text="ClosePackingList" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbCloseQuery" runat="server" Text="Close" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbCancelQuery" runat="server" Text="Cancel" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbBlockQuery" runat="server" Text="Block" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbPackingListingQuery" runat="server" Text="PackingListing" type="checkbox"  ></asp:CheckBox>
                    ...
                    <tr>
                      ...
                      <%--        <td class="fieldNameLeft" style="height: 26px" nowrap>
                            <asp:Label ID="lblExpressDelegateQuery" runat="server">物料委托</asp:Label>
                        </td>
                        <td   class="fieldValue" style="height: 26px">
                             <asp:TextBox ID="txtExpressDelegateQuery" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>--%>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="fieldValue" style="height: 26px">
                             <asp:TextBox ID="txtMemoEdit" runat="server" CssClass="textbox" Width="430px"></asp:TextBox>
                              ...
                              <td class="fieldNameLeft" style="height: 26px" nowrap>
                            <asp:Label ID="lblExpressDelegateEdit" runat="server">物料委托</asp:Label>
                        </td>
                        <td   class="fieldValue" style="height: 26px">
                             <asp:TextBox ID="txtExpressDelegateEdit" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>
                        <td width="100%">
                        </td>
                    </tr>
            ...
            <td>
                <table class="toolBar">
                    <tr>
                        ...
                        <td class="toolBar">
                                        <input class="submitImgButton" id="cmdPackageOutLine" type="submit" value="线下包装" name="cmdNoPackage"
                                            runat="server" onserverclick="cmdPackageOutLine_ServerClick">
                                    </td>

                     <%--     <td class="toolBar">
                         <input class="submitImgButton" id="cmdForceClose" type="submit" value="强制关单" name="cmdInitial"
                                runat="server" onserverclick="cmdForceClose_ServerClick" />
                        </td>--%>
