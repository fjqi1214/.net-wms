...
<%@ Page language="c#" Codebehind="FQueryTransDtlSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FQueryTransDtlSP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 交易单据</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								...
								<td><asp:TextBox Runat="server" ID="txtTicketNoQuery" Width="130px" CssClass="textbox" Enabled="False"></asp:TextBox>
								<td class="fieldNameLeft" noWrap><asp:label id="lblTransNameQuery" runat="server">单据名称</asp:label></td>
								<td><asp:TextBox Runat="server" ID="txtTransTypeQuery" Width="130px" CssClass="textbox" Enabled="False"></asp:TextBox></td>
								<td class="fieldName" noWrap><asp:label id="lblTicketUserQuery" runat="server">制单人</asp:label></td>
								<td><asp:TextBox Runat="server" ID="txtTicketUserQuery" Width="130px" CssClass="textbox" Enabled="False"></asp:TextBox></td>
							...
							<tr>
								...
								<td class="fieldName" noWrap><asp:label id="lblTicketDateQuery" runat="server"> 制单日期</asp:label></td>
								<td><asp:TextBox Runat="server" ID="txtTicketDateQuery" Width="130px" CssClass="textbox" Enabled="False"></asp:TextBox></td>
