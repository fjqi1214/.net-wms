<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FStorLocTransDetailSN.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FStorLocTransDetailSN" %>
...
<html>
<head>
    <title>FStorLocTransDetailSN</title>
                    ...
                    <tr>
                            ...
                            <asp:TextBox ID="txtPageEdit" runat="server" Width="150px" 
                                CssClass="textbox" ></asp:TextBox></td>
                                   <td class="fieldValue" style="display: none" >
                            <asp:TextBox ID="txtFPageEdit" runat="server" Width="150px" 
                                CssClass="textbox" ></asp:TextBox></td>
