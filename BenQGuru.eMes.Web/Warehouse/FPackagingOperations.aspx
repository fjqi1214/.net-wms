<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FPackagingOperations.aspx.cs"
    Inherits="BenQGuru.eMES.Web.Warehouse.FPackagingOperations" %>
            ...
            <td>
                <table class="query" height="100%" width="100%">
                    ...
                    <tr style="display: none">
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="Label1" runat="server">拣货任务令号</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 159px">
                            <asp:TextBox ID="TextBox1" runat="server" Width="150px" DESIGNTIMEDRAGDROP="257"
                                CssClass="textbox"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="Label2" runat="server">发货箱单号</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 159px">
                            <asp:TextBox ID="TextBox2" runat="server" Width="150px" DESIGNTIMEDRAGDROP="257"
                                CssClass="textbox" Enabled="false"></asp:TextBox>
                        </td>
                        <td style="width: 100%">
                        </td>
                        <td class="fieldName">
                            <input class="submitImgButton" id="Submit1" type="submit" value="查 询" name="btnQuery"
                                runat="server">
                        </td>
                    </tr>
                </table>
