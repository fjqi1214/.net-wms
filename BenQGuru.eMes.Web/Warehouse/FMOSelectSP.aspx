...
<%@ Page language="c#" Codebehind="FMOSelectSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FMOSelectSP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblFMOSelectSPTitle" runat="server" CssClass="labeltopic"> 工单选择</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<tr>
								...
								<td class="fieldValue" style="WIDTH: 159px"><asp:textbox id="txtMOCodeQuery" runat="server" Width="150px" CssClass="textbox"></asp:textbox></td>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
			...
			<input type="hidden" id="txtReturnCode" runat="server" NAME="txtReturnCode">
		</form>
	</body>
</HTML>
