<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FExpiredValidityMaterialRecord.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FExpiredValidityMaterialRecord" %>
                    ...
                    <tr>
                        ...
                        <td class="fieldValue" nowrap>
                         ...
                         <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblSupValidityCount" runat="server">超期次数</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 159px">
                            <asp:TextBox ID="txtSupValidityCount" runat="server" Width="150px" DESIGNTIMEDRAGDROP="257"
