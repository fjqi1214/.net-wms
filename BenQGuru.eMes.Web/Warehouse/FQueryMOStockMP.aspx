<%@ Page language="c#" Codebehind="FQueryMOStockMP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FQueryMOStockMP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 工单用料查询</asp:label></td>
				</tr>
				<tr>
					<td>
