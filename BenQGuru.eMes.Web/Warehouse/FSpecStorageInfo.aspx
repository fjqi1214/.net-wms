<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSpecStorageInfo.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FSpecStorageInfo" %>
...
<body>
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">特殊物料库存信息</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblDQMCODEQuery" runat="server">鼎桥物料号</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtDQMCODEQuery" runat="server" CssClass="require" Width="130px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblStorageCodeQuery" runat="server">仓库</asp:Label>
                        </td>
                        <td class="fieldValue" style="width: 100%">
                            <asp:TextBox ID="txtStorageCodeQuery" runat="server" CssClass="require" Width="130px"></asp:TextBox>
                        </td>
