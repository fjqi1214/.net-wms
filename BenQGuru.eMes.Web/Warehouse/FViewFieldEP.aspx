<%@ Page Language="c#" CodeBehind="FViewFieldEP.aspx.cs" EnableEventValidation="false"
    AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.Warehouse.FViewFieldEP" %>
...
<body ms_positioning="GridLayout">
    ...
    <table width="100%" id="tableMain">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitleField" runat="server" CssClass="labeltopic"> 栏位选择</asp:Label>
            </td>
        </tr>
        <tr>
            <td class="fieldGrid">
                <table width="100%">
                    <tr>
                        ...
                        <td valign="middle">
                            <img src="../Skin/Image/right_0.gif" alt="" border="0" onclick="ItemSelect();" /><br />
                            <br />
                            <img src="../Skin/Image/left_0.gif" alt="" border="0" onclick="ItemUnSelect();" />
