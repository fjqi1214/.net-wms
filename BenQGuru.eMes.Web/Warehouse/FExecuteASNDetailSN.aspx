<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FExecuteASNDetailSN.aspx.cs"
    Inherits="BenQGuru.eMES.Web.WarehouseWeb.FExecuteASNDetailSN" %>
...
<body>
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">仓库执行入库指令明细SN</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblSTNOQuery" runat="server">入库指令号</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtSTNOQuery" runat="server" CssClass="require" Width="130px" Enabled="false"></asp:TextBox>
                        </td>
                        <td class="fieldValue" style="width: 100%">
                            <asp:TextBox ID="txtSTLINEQuery" runat="server" CssClass="require" Width="130px"
