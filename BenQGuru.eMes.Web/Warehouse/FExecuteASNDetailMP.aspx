<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FExecuteASNDetailMP.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FExecuteASNDetailMP" %>
...
<body ms_positioning="GridLayout">
    ...
    <table id="table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">仓库执行入库指令明细查询</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
