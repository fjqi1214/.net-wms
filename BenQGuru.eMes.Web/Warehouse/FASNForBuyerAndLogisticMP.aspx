<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FASNForBuyerAndLogisticMP.aspx.cs" Inherits="BenQGuru.eMES.Web.WarehouseWeb.FASNForBuyerAndLogisticMP" %>
...
<body ms_positioning="GridLayout">
    ...
    <table id="table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">入库指令创建-Buyer&物流</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <asp:CheckBox ID="chbInINVQuery" runat="server" Text="入库" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbIQCQuery" runat="server" Text="IQC" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbIQCRejectionQuery" runat="server" Text="IQC拒收" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbOnLocationQuery" runat="server" Text="上架" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbInReceiveQuery" runat="server" Text="初检" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbReceiveRejectionQuery" runat="server" Text="初检拒收" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbinReleaseQuery" runat="server" Text="初始化" type="checkbox"  ></asp:CheckBox>
            <asp:CheckBox ID="chbWaitReceiveQuery" runat="server" Text="待收货" type="checkbox"  ></asp:CheckBox>
              <asp:CheckBox ID="chbIsHasRejectionQuery" runat="server" Text="是否含拒收" type="checkbox"  ></asp:CheckBox>
                                </td>
            ...
            <td>
                <table class="edit" height="100%" cellpadding="0" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue" style="height: 26px">
                             <asp:DropDownList ID="drpStorageInTypeEdit" AutoPostBack="true" runat="server"  
                                 CssClass="require" Width="120px"
                                DESIGNTIMEDRAGDROP="94" 
                                 onselectedindexchanged="drpStorageInTypeEdit_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                        ...
                        <td class="fieldNameLeft" style="height: 26px" nowrap colspan="4">
                            <asp:CheckBoxList ID="cblFlag" AutoPostBack="true" runat="server" 
                                RepeatDirection="Horizontal" 
                                onselectedindexchanged="cblFlag_SelectedIndexChanged" >
                                <asp:ListItem  Value="Direct_Flag">供应商直发入库指令</asp:ListItem>
                                <asp:ListItem Value="Exigency_Flag">紧急物料标识</asp:ListItem>
                                <asp:ListItem Value="Rejects_Flag">生产退料入不良品库</asp:ListItem>
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="fieldValue" style="height: 26px">
                            <asp:TextBox ID="txtPickNoEdit" runat="server" Width="120px" CssClass="textbox"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                       ...
                       <td colspan="10">
                            <table class="toolBar">
                                <tr>
                                    ...
                                    <td class="toolBar">
                                        <input class="submitImgButton" id="cmdSendDown" type="submit" value="下发" name="cmdSendDown"
                                            runat="server" onserverclick="cmdSendDown_ServerClick" />
                                    </td>
                                    <td class="toolBar">
                                        <input class="submitImgButton" id="cmdInStorage" type="submit" value="入库" name="cmdInStorage"
                                            runat="server" onserverclick="cmdInStorage_ServerClick"   onclick="GetSelectRowGUIDS('gridWebGrid')"/>
                                    </td>
                                     <td class="toolBar">
                        ...
                        <td  colspan="10">
                            <table class="Import">
                                ...
                                <tr>    
					                ...
					                <td class="fieldValue">
						                <input id="FileImport" name="FileImport" type="file" runat="server" style="WIDTH: 454px" size="56" class="textbox" />
					                </td>
					                <td class="toolBar">
                                        <input class="submitImgButton" id="cmdEnter" type="submit" value="导入" name="cmdSave" runat="server" onserverclick="cmdEnter_ServerClick" />
                                    </td>
                           <%--         <td align="center">
                                        <input class="submitImgButton" id="cmdView" type="submit" value="察 看" name="cmdView" visible="true" runat="server" onserverclick="cmdView_ServerClick"/>
                                    </td>--%>
                                   <%--  <td nowrap>
                                <a id="aFileDownLoad" style="display: none; color: blue" href="" target="_blank"
                                    runat="server">
                                    <asp:Label ID="lblDown" runat="server">查看附件</asp:Label></a> <span style="cursor: pointer;
                                        color: blue; text-decoration: underline">  
                                        <asp:Label ID="lblDown1" runat="server">查看附件</asp:Label></span>
                            </td>--%>
                                </tr>
                            </table>
                        </td>
