<%@ Page language="c#" Codebehind="FAlertSampleMP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.Alert.FAlertSampleMP" %>
	...
	<body topmargin="0" MS_POSITIONING="GridLayout" bottomMargin="0" rightMargin="0" leftMargin="0">
		<form id="Form1" method="post" runat="server">
			<table height="99%" width="100%">
				<tr>
					<td>
						<asp:Label id="lblTitle" runat="server" CssClass="labeltopic">手动预警样例</asp:Label></td>
				</tr>
				<tr height="100%">
					<td class="fieldGrid">
				...
				<tr class="normal">
					<td>
						<table class="edit" height="100%" cellPadding="0" width="100%">
							<tr>
								<td width="100"><asp:label id="lblSampleDescEdit" runat="server">样例描述</asp:label></td>
								<td><asp:TextBox id="txtSampleDescEdit" CssClass="require" runat="server" Width="408px"></asp:TextBox>
									<asp:TextBox id="txtOID" runat="server" Height="0px" Width="0px"></asp:TextBox></td>
							</tr>
						</table>
					</td>
				</tr>
