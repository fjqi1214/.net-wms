...
<%@ Page language="c#" Codebehind="FManualAlertMP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.Alert.FManualAlertMP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic"> 手动预警</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" width="100%">
							<tr>
								<td class="fieldNameLeft" width="50" noWrap><asp:label id="lblAlertLevel" runat="server"> 预警级别</asp:label></td>
								<td class="fieldValue" width="100" nowrap>
									<asp:DropDownList id="drpAlertLevel" runat="server" Width="112px" CssClass="dropdownlist">
								...
								<td align="left"><INPUT class="submitImgButton" id="cmdQuery" type="submit" value="查 询" name="btnQuery"
										runat="server"></td>
							</tr>
						</table>
					</td>
