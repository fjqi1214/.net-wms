<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FAlertErrorCodeMP.aspx.cs" Inherits="BenQGuru.eMES.Web.Alert.FAlertErrorCodeMP" %>
                    ...
                    <table class="query" style="height: 50%; width: 100%;">
                        <tr>
                            <td nowrap="nowrap" colspan="5" style="text-align:left;font-weight:bold;">
                                <asp:Label ID="lblAlertErrorCode" runat="server">不良原因预警</asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="fieldValue">
                                <cc2:selectabletextbox id="txtErrorCode" runat="server" Type="errorcausewithgroup" Readonly="false" CanKeyIn="false" Width="250px" CssClass="require"></cc2:selectabletextbox>
                            </td>
