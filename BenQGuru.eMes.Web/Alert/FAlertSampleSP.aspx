...
<%@ Page language="c#" Codebehind="FAlertSampleSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.Alert.FAlertSampleSP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td>
						<asp:Label id="lblFAlertSampleSPTitle" runat="server">样例选择</asp:Label></td>
				</tr>
				<tr height="100%">
