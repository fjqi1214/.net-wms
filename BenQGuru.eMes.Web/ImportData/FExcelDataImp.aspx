<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FExcelDataImp.aspx.cs"
    Inherits="BenQGuru.eMES.Web.ImportData.FExcelDataImp" %>
...
<body>
    ...
    <table id="Table1" style="z-index: 101; left: 8px; position: absolute; top: 8px;
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <table class="query" id="Table2" style="height: 100%; width: 100%;">
                        <tr align="right">
                            ...
                            <td class="toolBar">
                                <input class="submitImgButton" id="cmdImport" type="submit" value="导入" name="cmdImport"
