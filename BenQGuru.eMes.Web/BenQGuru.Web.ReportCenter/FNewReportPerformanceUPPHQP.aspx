<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FNewReportPerformanceUPPHQP.aspx.cs"
    Inherits="BenQGuru.Web.ReportCenter.FNewReportPerformanceUPPHQP" %>
...
<head runat="server">
    <title>FNewReportPerformanceUPPHQP</title>
</head>
<body scroll="yes" ms_positioning="GridLayout" onload="if (typeof(scrollToBottom)!='undefined' && scrollToBottom) scrollTo(document.body.scrollLeft,document.body.scrollHeight-document.body.clientHeight-60);">
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> UPPH </asp:Label>
            </td>
        </tr>
        <tr>
            <td>
