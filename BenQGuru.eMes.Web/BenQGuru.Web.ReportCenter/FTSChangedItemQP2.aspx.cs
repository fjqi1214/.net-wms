...
namespace BenQGuru.eMES.Web.WebQuery
{
	...
	public partial class FTSChangedItemQP2 : BaseRQPage
	{
		...
		{
			this._gridHelper.GridHelper.AddColumn( "MItemCode1", "新物料料号",	null);
			this._gridHelper.GridHelper.AddColumn( "MCard1", "新物料序列号",	null);
			this._gridHelper.GridHelper.AddColumn( "SItemCode1", "原物料料号",	null);
			this._gridHelper.GridHelper.AddColumn( "MSCard1", "原物料序列号",	null);
			this._gridHelper.GridHelper.AddColumn( "Location1", "零件位置",	null);
			this._gridHelper.GridHelper.AddColumn( "LotNO2", "批号",	null);
			this._gridHelper.GridHelper.AddColumn( "VendorCode",		"厂商",	null);
			this._gridHelper.GridHelper.AddColumn("VendorItemCode",			"厂商料号",null);
			this._gridHelper.GridHelper.AddColumn("DateCode",			"生产日期",null);		
			this._gridHelper.GridHelper.AddColumn( "Reversion",		"料品版本",	null);
			this._gridHelper.GridHelper.AddColumn( "PCBA",		"PCBA版本",	null);
			this._gridHelper.GridHelper.AddColumn( "BIOS",		"BIOS版本",	null);
