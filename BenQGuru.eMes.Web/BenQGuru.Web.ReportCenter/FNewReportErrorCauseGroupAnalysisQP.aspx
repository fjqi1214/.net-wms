<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FNewReportErrorCauseGroupAnalysisQP.aspx.cs"
    Inherits="BenQGuru.Web.ReportCenter.FNewReportErrorCauseGroupAnalysisQP" %>
...
<head runat="server">
    <title>FNewReportErrorCauseGroupAnalysisQP</title>
...
<body scroll="yes" ms_positioning="GridLayout" onload="if (typeof(scrollToBottom)!='undefined' && scrollToBottom) scrollTo(document.body.scrollLeft,document.body.scrollHeight-document.body.clientHeight-60);">
    ...
    <table width="100%" id="Table1" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 不良原因组分析 </asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <table width="100%" cellspacing ="0" cellpadding ="0">
                    ...
                    <tr>
                        <td align="center">
                            <uc6:UCPieChartProcess ID="pieChart" runat="server">
                            </uc6:UCPieChartProcess>
                        </td>
                    </tr>
                </table>
            </td>
