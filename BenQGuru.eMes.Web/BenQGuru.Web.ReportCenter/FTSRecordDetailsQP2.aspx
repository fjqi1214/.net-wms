<%@ Page language="c#" Codebehind="FTSRecordDetailsQP2.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FTSRecordDetailsQP2" %>
					...
					<td style="HEIGHT: 19px">
						<table cellpadding="0" cellspacing="0" id="Table5">
							<tr>
								...
								<td><asp:label id="lblRepairRecodeDe" runat="server" CssClass="Title2">维修记录明细</asp:label></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table class="query" height="100%" width="100%" id="Table2">
							...
							<TR>
								...
								<td class="fieldName" noWrap>
									<asp:label id="lblScrapCauseQuery" runat="server">报废原因</asp:label>
								</td>
								<td class="fieldValue">
									<asp:TextBox id="txtScrapCauseQuery" runat="server" CssClass="textbox" ReadOnly="True"></asp:TextBox>
								</td>
								<td></td>
							</TR>
						</table>
