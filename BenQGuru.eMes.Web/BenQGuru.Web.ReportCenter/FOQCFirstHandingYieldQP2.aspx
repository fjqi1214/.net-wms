<%@ Page language="c#" Codebehind="FOQCFirstHandingYieldQP2.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FOQCFirstHandingYieldQP2" %>
...
<HTML>
	<HEAD>
		<title>FOQCFirstHandingYieldQP</title>
				...
				<tr class="moduleTitle">
					<td><table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td><asp:label id="lblFQCEligibility" runat="server" CssClass="Title2">FQC一交合格率</asp:label></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table class="query" height="100%" width="100%">
							<TR>
								...
								<td class="fieldValue"><cc2:selectabletextbox id="txtItem" runat="server" Width="100px" Type="item"></cc2:selectabletextbox></td>
								<td class="fieldName" noWrap><asp:label id="lblStartDateQuery" runat="server">起始日期</asp:label></td>
								<td class="fieldValue"><uc1:emesdate id="dateStartDateQuery" runat="server" CssClass="require" width="150"></uc1:emesdate></td>
								<td class="fieldName" noWrap><asp:label id="lblEndDateQuery" runat="server">结束日期</asp:label></td>
								<td class="fieldValue"><uc1:emesdate id="dateEndDateQuery" runat="server" CssClass="require" width="150"></uc1:emesdate></td>
