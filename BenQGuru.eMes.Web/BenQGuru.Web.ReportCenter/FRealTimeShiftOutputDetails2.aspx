<%@ Page language="c#" Codebehind="FRealTimeShiftOutputDetails2.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FRealTimeShiftOutputDetails2" %>
				...
				<tr class="moduleTitle">
					<td><table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td><asp:label id="lblRealOutDe" runat="server" CssClass="Title2">实时产出明细</asp:label></td>
							</tr>
						</table>
					</td>
				</tr>
