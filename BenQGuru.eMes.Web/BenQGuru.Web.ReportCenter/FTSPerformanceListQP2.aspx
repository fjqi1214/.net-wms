...
<%@ Page language="c#" Codebehind="FTSPerformanceListQP2.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FTSPerformanceListQP2" %>
					...
					<td style="HEIGHT: 19px">
						<table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td><asp:label id="lblRepairQueryDe" runat="server" CssClass="Title2">维修绩效查询明细</asp:label></td>
							</tr>
						</table>
					</td>
				</tr>
