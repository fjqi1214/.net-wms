...
<%@ Page language="c#" Codebehind="FOQCSDR2.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FOQCSDR2" %>
					...
					<td style="HEIGHT: 19px">
						<table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td><asp:label id="lblSDRTitle" runat="server" CssClass="Title2">OQC SDR</asp:label></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table class="query" height="100%" width="100%" id="Table2">
							...
							<tr>
								...
								<td class="fieldValue">
									<asp:DropDownList id="drpDateGroup" runat="server" Width="120">
							...
							<tr>
								...
								<TD class="fieldValue" noWrap>
									<TABLE cellSpacing="0" cellPadding="0" border="0">
										<TR>
											<TD><uc1:emesdate id="txtOQCBeginDate" runat="server" width="80" CssClass="require"></uc1:emesdate></TD>
											<TD><uc1:emestime id="txtOQCBeginTime" runat="server" width="60" CssClass="require"></uc1:emestime></TD>
										</TR>
									</TABLE>
								</TD>
								...
								<TD class="fieldValue" noWrap>
									<TABLE cellSpacing="0" cellPadding="0" border="0">
										<TR>
											<TD><uc1:emesdate id="txtOQCEndDate" runat="server" width="80" CssClass="require"></uc1:emesdate></TD>
											<TD><uc1:emestime id="txtOQCEndTime" runat="server" width="60" CssClass="require"></uc1:emestime></TD>
										</TR>
									</TABLE>
								</TD>
								<td></td>
