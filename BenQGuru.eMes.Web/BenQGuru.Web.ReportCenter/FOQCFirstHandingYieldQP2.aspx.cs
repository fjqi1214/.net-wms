...
namespace BenQGuru.eMES.Web.WebQuery
{
	...
	/// </summary>
	public partial class FOQCFirstHandingYieldQP2 : BaseRQPage
	{
		...
		private void _initialWebGrid()
		{
			...
			this._gridHelper.GridHelper.AddColumn("FirstHandingAmount","一次提交总数",null);
			this._gridHelper.GridHelper.AddColumn("FirstHandingYieldAmount","一交合格数",null);
			this._gridHelper.GridHelper.AddColumn("FirstHandingYieldPercent","一次交验合格率",null);
			this._gridHelper.GridHelper.AddLinkColumn("FirstHandingDetail",	"一次提交明细",null);
		...
		private void _helper_GridCellClick(object sender, EventArgs e)
		{
			...
			{			
				this.Response.Redirect( 
					...
					"FOQCFirstHandingYieldDetailQP2.aspx",
					new string[]{
									"MODELCODE",
									"ITEMCODE",
									"STARTDATE",
