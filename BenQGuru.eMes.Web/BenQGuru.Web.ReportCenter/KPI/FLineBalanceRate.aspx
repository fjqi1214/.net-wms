<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FLineBalanceRate.aspx.cs" Inherits="BenQGuru.Web.ReportCenter.KPI.FLineBalanceRate" %>
...
<form id="form1" method="post" runat="server">
    ...
    <tr class="moduleTitle">
		<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic">线体平衡率</asp:label></td>
	</tr>
	<tr>
		<td>
			<table class="query" height="100%" width="100%">
                <tr>
                    <td colspan="8" style="border:0px;float:left;width:75px;height:22px;line-height:22px;text-align:left;font-weight:bold;"><asp:Label ID="lblWhereConditions" runat="server" Text="过滤条件"></asp:Label></td>
                </tr>
				<tr>
					...
					<%--<td class="fieldValue" nowrap="noWrap"><cc2:selectabletextbox id="txtMOCodeWhere" runat="server" Type="singlemo" Readonly="false" CanKeyIn="true" Width="131"></cc2:selectabletextbox></td>--%>
					<%--<TD class="fieldName" noWrap><asp:label id="lblItemCodeQuery" runat="server">产品代码</asp:label></TD>
					<td class="fieldValue" nowrap="noWrap"><cc2:SelectableTextBox id="txtItemCodeQuery" runat="server" type="singleitem" readonly="false" cankeyin="true" width="131"></cc2:SelectableTextBox></td>--%>
					...
					<TD class="fieldValue" noWrap><asp:DropDownList ID="ddlShiftCodeWhere" runat="server" Width="131"></asp:DropDownList></TD>
                </tr>
				<tr>
				    
					<%--<TD class="fieldName" noWrap><asp:label id="lblMOTypeQuery" runat="server">时段</asp:label></TD>
					<TD class="fieldValue"><asp:dropdownlist id="drpMoTypeQuery" runat="server" Width="100px" CssClass="textbox"></asp:dropdownlist></TD>--%>	
	...
	<tr height="100%">
	        <td align="center" style=" padding-top:20px;" >
	            <igGauge:UltraGauge runat="server" ID="UltraGauge1" BackColor="Transparent" ForeColor="ControlLightLight" Width="350" Height="350" OnAsyncRefresh="UltraGauge1_AsyncRefresh">
                  ...
                  <Gauges>
                    <igGaugeProp:RadialGauge >
                      ...
                      <Annotations>
                        ...
                        <Label FormatString="线体平衡率" Font="黑体, 20px">
                        <BrushElements>
