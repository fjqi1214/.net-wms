<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FActualProductivity.aspx.cs" Inherits="BenQGuru.Web.ReportCenter.ActualProductivity" %>
...
<form id="form1" method="post" runat="server">
    ...
    <tr class="moduleTitle">
		<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic">实际生产率</asp:label></td>
	</tr>
	<tr>
		<td>
			<table class="query" height="100%" width="100%">
				...
				<tr>
					...
					<TD class="fieldValue" noWrap><asp:DropDownList ID="ddlShiftCodeWhere" 
                            runat="server" Width="131" ></asp:DropDownList></TD>
                  ...
                  <Gauges>
                    <igGaugeProp:RadialGauge >
                      ...
                      <Annotations>
                        ...
                        <Label FormatString="实际生产率" Font="黑体, 20px">
                        <BrushElements>
