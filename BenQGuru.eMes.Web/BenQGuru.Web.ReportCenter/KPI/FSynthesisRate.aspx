<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSynthesisRate.aspx.cs" Inherits="BenQGuru.Web.ReportCenter.KPI.FSynthesisRate" %>
...
<form id="form1" method="post" runat="server">
    ...
    <tr class="moduleTitle">
		<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic">综合能力</asp:label></td>
	</tr>
	<tr>
		<td>
			<table class="query" height="100%" width="100%">
				...
				<tr>
					...
					<TD class="fieldName" noWrap><asp:label id="lblRating" runat="server">RATING</asp:label></TD>
					<TD class="fieldValue" noWrap><asp:DropDownList ID="ddlRating" runat="server" Width="131"></asp:DropDownList></TD>
					<td></td>
					<td></td>
                  ...
                  <Gauges>
                    <igGaugeProp:RadialGauge >
                      ...
                      <Annotations>
                        ...
                        <Label FormatString="综合能力" Font="黑体, 20px">
                        <BrushElements>
