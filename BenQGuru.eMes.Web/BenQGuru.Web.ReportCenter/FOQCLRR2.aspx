							...
							<tr>
								...
								<td valign="top">
									<table border="0">
										...
										<tr>
											<td class="fieldNameLeft"><asp:Label Runat="server" ID="lblLRR" Font-Bold="True">LRR 汇总</asp:Label></td>
										...
										<tr>
											<td class="fieldNameLeft"><asp:Label Runat="server" ID="lblDPPM" Font-Bold="True">DPPM 汇总</asp:Label></td>
