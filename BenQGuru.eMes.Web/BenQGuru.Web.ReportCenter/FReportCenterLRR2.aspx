...
<%@ Page language="c#" Codebehind="FReportCenterLRR2.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FReportCenterLRR2" %>
					...
					<td>
						<table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td><asp:label id="lblTSInfoQP" runat="server" CssClass="Title2">维修资料统计</asp:label></td>
							</tr>
						</table>
					</td>
				</tr>
