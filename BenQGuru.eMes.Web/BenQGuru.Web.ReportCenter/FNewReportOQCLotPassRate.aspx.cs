...
{
    public partial class FNewReportOQCLotPassRate : BaseQPageNew
    {
        #region 页面初始化
        ...
        private void InitWhereControls()
        {
            ...
            this.UCWhereConditions1.SetControlPosition(5, 2, UCWhereConditions1.PanelCrewCodeWhere.ID);
        }
        ...
        private string GetCoreTableDetail()
        {
            ...
            returnValue += "COUNT(lotno) AS lotcount, SUM(DECODE(lotstatus, '" + OQCLotStatus.OQCLotStatus_Pass + "', 1, 0)) AS passcount ";
            ...
            returnValue += "WHERE tbllot.lotstatus IN ('" + OQCLotStatus.OQCLotStatus_Pass + "', '" + OQCLotStatus.OQCLotStatus_Reject + "') ";
            returnValue += "GROUP BY tbllot.lotno, tbllot.itemcode, tbllot.shiftday, tbllot.sscode, tbllot.rescode, tblss.bigsscode, tblline2crew.crewcode ";
        ...
        private string GetFormular(string compareType)
        {
            ...
            returnValue = "SUM(**.passcount) AS oqcpasscount, SUM(**.lotcount) AS oqclotcount, SUM(**.passcount)/SUM(**.lotcount) AS oqclotpassrate";
        ...
        protected override void DoQuery()
        {
            ...
            if (this.CheckBeforeQuery())
            {
                ...
                dim3PropertyList.Add(new ReportGridDim3Property("OQCLotCount", "0", "SUM", "SUM", false));
                dim3PropertyList.Add(new ReportGridDim3Property("OQCPassCount", "0", "SUM", "SUM", false));                
                dim3PropertyList.Add(new ReportGridDim3Property("OQCLotPassRate", "0.00%", "DIV({-1},{-2})", "DIV({-1},{-2})", false));
                    ...
                    || UCDisplayConditions1.GetDisplayType().Trim().ToLower() == NewReportDisplayType.HistogramChart)
                {
                    ...
                    dataPropertyList.Add("OQCLotPassRate");
                    ...
                    {
                        obj.TempValue = obj.OQCLotPassRate.ToString();
                        //时段、班次、天、周、月、年
