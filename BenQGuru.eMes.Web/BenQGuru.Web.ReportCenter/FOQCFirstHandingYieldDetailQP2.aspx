...
<%@ Page language="c#" Codebehind="FOQCFirstHandingYieldDetailQP2.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FOQCFirstHandingYieldDetailQP2" %>
					...
					<TD>
						<table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td><asp:Label id="lblFQC" runat="server">FQC一交合格率明细</asp:Label><INPUT class="textbox" id="txtSeq" style="DISPLAY: none; WIDTH: 120px" readOnly name="textfield"
										runat="server"></td>
							</tr>
						</table>
					</TD>
					...
					<TD>
						<TABLE class="query" id="Table2" height="100%" width="100%">
							<TR>
								...
								<TD class="fieldValue"><STRONG><STRONG><INPUT class="textbox" style="WIDTH: 120px" name="textfield2" id="txtStartDate" runat="server"
												readOnly></STRONG></STRONG></TD>
