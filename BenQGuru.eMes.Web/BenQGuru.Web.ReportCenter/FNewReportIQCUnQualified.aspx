<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FNewReportIQCUnQualified.aspx.cs"
    Inherits="BenQGuru.Web.ReportCenter.FNewReportIQCUnQualified" %>
...
<head id="Head1" runat="server">
    <title>FNewReportIQCUnQualified</title>
    <script language="javascript">
        function Grid_InitializeMergeCells(sender, eventArgs) {
            Grid_Initialize(sender, eventArgs);
            var colName = "VendorCode";  //此处要改为需要合并的列的key
            var textTag;
            var indexTag = 0;
            var spanIndex = 0;
...
<body scroll="yes" ms_positioning="GridLayout" onload="if (typeof(scrollToBottom)!='undefined' && scrollToBottom) scrollTo(document.body.scrollLeft,document.body.scrollHeight-document.body.clientHeight-60);">
    ...
    <table height="100%" width="100%" id="Table1" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> IQC入厂检验不合格率 </asp:Label>
            </td>
        </tr>
        <tr>
            <td>
