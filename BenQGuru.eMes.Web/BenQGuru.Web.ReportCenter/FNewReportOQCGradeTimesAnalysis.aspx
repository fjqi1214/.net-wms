<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FNewReportOQCGradeTimesAnalysis.aspx.cs"
    Inherits="BenQGuru.Web.ReportCenter.FNewReportOQCGradeTimesAnalysis" %>
...
<head id="Head1" runat="server">
    <title>FNewReportOQCSampleNGRate</title>
    <script type="text/javascript">

        function setColumn(obj, index) {
            grid = $find("gridWebGrid");
            grid.get_columns().get_column(index).set_hidden(obj);
        }
...
<body scroll="yes" ms_positioning="GridLayout" onload="if (typeof(scrollToBottom)!='undefined' && scrollToBottom) scrollTo(document.body.scrollLeft,document.body.scrollHeight-document.body.clientHeight-60);">
    ...
    <table height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 直通率报表 </asp:Label>
            </td>
        </tr>
        <tr>
            <td>
