...
{
	/// <summary>
	/// FRealTimeShiftInputDetails 的摘要说明。
	/// </summary>
	public partial class FRealTimeShiftInputDetails2 : BaseRQPage
	{
...
//			this.txtMoCodeQuery.Text = "";				//工单
		...
		{
			return new FacadeFactory(base.DataProvider).CreateQueryFacade1().QueryRealTimeInputQuantity(
		...
		private void _processDataDourceToGrid()//(object sender, EventArgs e)
		{
			...
			if( source != null )
			{				
				foreach(RealTimeInputQuantity real in source)
				{
					bool isAdded = false;
