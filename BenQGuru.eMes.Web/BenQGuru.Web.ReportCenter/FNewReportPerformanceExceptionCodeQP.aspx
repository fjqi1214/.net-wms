<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FNewReportPerformanceExceptionCodeQP.aspx.cs"
    Inherits="BenQGuru.Web.ReportCenter.FNewReportPerformanceExceptionCodeQP" %>
...
<head runat="server">
    <title>FNewReportPerformanceExceptionCodeQP</title>
</head>
<body scroll="yes" ms_positioning="GridLayout" onload="if (typeof(scrollToBottom)!='undefined' && scrollToBottom) scrollTo(document.body.scrollLeft,document.body.scrollHeight-document.body.clientHeight-60);">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 非生产性损失统计 </asp:Label>
            </td>
        </tr>
        <tr>
            <td>
