...
namespace BenQGuru.eMES.Web.WebQuery
{
	...
	public partial class FOQCLRR2: BaseRQPage
	{
		...
		private void _initialWebGrid()
		{
			...
			this._gridHelper.GridHelper.AddColumn("LOTTOTALCOUNT",			"抽检LOT总数",null);
			this._gridHelper.GridHelper.AddColumn("LOTNGCOUNT",		"批退LOT总数",null);
			this._gridHelper.GridHelper.AddColumn("LOTSIZE",		"送检总数",null);
			this._gridHelper.GridHelper.AddColumn("LOTSAMPLECOUNT",		"样本总数",null);
			this._gridHelper.GridHelper.AddColumn("LOTSAMPLENGCOUNT",		"不良总数",null);
