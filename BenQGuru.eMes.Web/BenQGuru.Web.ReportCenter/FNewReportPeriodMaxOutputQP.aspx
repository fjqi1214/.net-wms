<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FNewReportPeriodMaxOutputQP.aspx.cs"
    Inherits="BenQGuru.Web.ReportCenter.FNewReportPeriodMaxOutputQP" %>
...
<head id="Head1" runat="server">
    <title>FNewReportQuantityQP</title>
</head>
            ...
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td>
                            <div style="height: 30px; clear: both; width: 200px; line-height: 22px; text-align: left;
                                font-weight: bold;">
                                <asp:Label ID="lblMaxOrAvg" runat="server" Text="最大或平均"></asp:Label>
                            </div>
                            <div style="height: 25px; clear: both; width: 200px; text-align: left;">
                                <asp:RadioButtonList ID="rblMaxOrAvg" runat="server" RepeatDirection="Horizontal">
                                </asp:RadioButtonList>
                            </div>
                        </td>
