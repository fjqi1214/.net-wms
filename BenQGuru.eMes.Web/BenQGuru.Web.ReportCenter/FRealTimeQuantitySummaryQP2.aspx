<%@ Page language="c#" Codebehind="FRealTimeQuantitySummaryQP2.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FRealTimeQuantitySummaryQP2" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td><asp:label id="lblRealTimeQuantitySummaryQP" runat="server" CssClass="Title2">实时产量</asp:label></td>
							</tr>
						</table>
					</td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							...
							<tr>
								<td class="fieldNameLeft">
									<asp:label id="lblStepSequence" runat="server">生产线</asp:label></td>
				...
				<tr height="100%">
					<td class="fieldGrid" id="GridTd" runat="server">
