<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FNewReportPerformanceDetailQP.aspx.cs"
    Inherits="BenQGuru.Web.ReportCenter.FNewReportPerformanceDetailQP" %>
...
<head runat="server">
    <title>FNewReportPerformanceDetailQP</title>
</head>
<body scroll="yes" ms_positioning="GridLayout" onload="if (typeof(scrollToBottom)!='undefined' && scrollToBottom) scrollTo(document.body.scrollLeft,document.body.scrollHeight-document.body.clientHeight-60);">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 生产绩效明细 </asp:Label>
            </td>
        </tr>
        <tr>
            <td>
