<%@ Page language="c#" Codebehind="FHistroyQuantitySummaryQP2.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FHistroyQuantitySummaryQP2" %>
				...
				<tr class="moduleTitle">
					<td><table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td><asp:label id="lblHistroyQuantitySummaryQP" runat="server" CssClass="Title2">历史产量</asp:label></td>
							</tr>
						</table>
					</td>
				</tr>
