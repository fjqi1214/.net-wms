<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FOQCCheckListQuery.aspx.cs"
    Inherits="BenQGuru.eMES.Web.OQC.FOQCCheckListQuery" %>
...
<html>
<head>
    <title>FOQCCheckListQuery</title>
...
<body ms_positioning="GridLayout">
    ...
    <table id="table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">OQC查询</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue" style="width: 159px">
                            <asp:DropDownList ID="drpPickNoQuery" runat="server" CssClass="textbox" Width="150px"
...
>>>>>>> .r3798
                    ...
                    <tr>
                        ...
                        <td class="fieldValue" style="width: 159px">
                            <asp:TextBox type="text" ID="txtAppCDateQuery" class='datepicker' runat="server"
                                Width="130px" />
                        </td>
                        <td class="fieldNameLeft" nowrap>
                        ...
                        <td class="fieldValue" style="width: 159px">
                            <asp:TextBox type="text" ID="txtAppEDateQuery" class='datepicker' runat="server"
                                Width="130px" />
                        </td>
...
<<<<<<< .mine
                        ...
                        <td class="fieldValue" style="width: 159px">
                            <asp:TextBox ID="txtCartonCode" runat="server" Width="150px" CssClass="textbox"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblSNEdit" runat="server">SN</asp:Label>
                        </td>
...
>>>>>>> .r3798
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtGFHWItemCodeQuery" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>
<<<<<<< .mine
                          <td class="fieldName" nowrap>
