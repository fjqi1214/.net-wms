<%@ Page Language="c#" CodeBehind="FFrozenQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.OQC.FFrozenQP" %>
...
<body ms_positioning="GridLayout">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> 隔离结果查询 </asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblRCardStartQuery" runat="server"> 起始序列号 </asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtRCardStartQuery" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblRCardEndQuery" runat="server"> 结束序列号</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtRCardEndQuery" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                    ...
                    <tr>
                        ...
                        <td class="fieldValue" style="height: 26px">
                            <cc2:selectabletextbox id="txtBIGLine" runat="server" CanKeyIn="true" Width="100px"
                                Type="bigline" Target="">
                            </cc2:selectabletextbox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
