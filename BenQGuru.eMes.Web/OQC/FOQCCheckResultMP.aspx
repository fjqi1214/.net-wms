<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FOQCCheckResultMP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.OQC.FOQCCheckResultMP" %>
...
<body ms_positioning="GridLayout">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic"> OQC检验</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" width="100%" style="height: 100%">
                    <tr>
                        <td class="fieldNameLeft" colspan="2" style="height: 26px" nowrap>
                            <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal" CellPadding="20">
                                <asp:ListItem Selected="True" Value="抽检" Text="SpotCheck" />
                                <asp:ListItem Value="加严全检" Text="FullCheck" />
                            </asp:RadioButtonList>
                        </td>
                        ...
                        <td class="fieldValue" style="height: 26px">
                            <asp:DropDownList ID="drpAQLStandardQuery" runat="server" CssClass="textbox" Width="110px"
                                AutoPostBack="true" OnSelectedIndexChanged="drpAQLStandardQuery_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td class="fieldName" style="height: 26px" nowrap>
                        ...
                        <td class="fieldValue" style="height: 26px;">
                            <asp:TextBox ID="txtAQLDesc" runat="server" BorderWidth="0" BackColor="#EAF2FB" ReadOnly="true"
                                Width="130px">0收0拒</asp:TextBox>
                        </td>
                        <td class="fieldName" style="height: 26px" nowrap>
                            <asp:Label ID="lblSamples" runat="server">样本数</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 26px">
                            <asp:TextBox ID="txtSamplesNum" runat="server" BorderWidth="0" BackColor="#EAF2FB"
                                ReadOnly="true" Width="130px">1000000</asp:TextBox>
                        </td>
                        <td class="fieldName" style="height: 26px" nowrap>
                            <asp:Label ID="lblRejection" runat="server">判退数</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 26px">
                            <asp:TextBox ID="txtRejectionNum" runat="server" BorderWidth="0" BackColor="#EAF2FB"
                                ReadOnly="true" Width="130px">10000000</asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="fieldValue" style="height: 26px">
                            <asp:TextBox ID="txtPickNo" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                            <asp:Label ID="lblStorageOutTypeQurey" runat="server">出库类型</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 26px">
                            <asp:TextBox ID="txtStorageOutTypeQurey" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                        ...
                        <td class="fieldValue" style="height: 26px">
                            <asp:TextBox ID="txtCarInvNoQurey" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>
            ...
            <td>
                <table class="edit" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:DropDownList ID="drpNGTypeEdit" runat="server" CssClass="require" Width="120px"
                                DESIGNTIMEDRAGDROP="94" AutoPostBack="true" OnSelectedIndexChanged="drpNGTypeEdit_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td class="fieldNameLeft" style="height: 26px" nowrap>
                    ...
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtCartonNoEdit" runat="server" Width="110px" CssClass="textbox"></asp:TextBox><asp:TextBox
                                ID="txtDQMCODEEdit" runat="server" CssClass="textbox" Visible="false"></asp:TextBox><asp:TextBox
                                    ID="txtCartonINVEdit" runat="server" CssClass="textbox" Visible="false"></asp:TextBox>
                        </td>
                        <td class="fieldName" style="height: 26px" nowrap>
                            <asp:Label ID="lbxSampleQty" runat="server">样本数</asp:Label>
                        </td>
                        <td class="fieldValue" style="height: 26px">
                            <asp:TextBox ID="txtSamplesSize1" runat="server"
                        ...
                        <td>
                            <table class="Import">
                                ...
                                <tr>
                                    ...
                                    <td class="fieldValue">
                                        <input id="FileImport" style="width: 454px" type="file" size="56" name="FileImport"
                                            class="textbox" runat="server" />
                                    </td>
                                    <td class="toolBar">
                                        <input class="submitImgButton" id="cmdEnter" type="submit" value="导入" name="cmdEnter"
                                    ...
                                    <td class="toolBar">
                                        <input class="DefaultInput" id="cmdExportOQCACL" type="submit" value="导出OQC异常联络单"
                                            name="cmdExportOQCACL" style="color: Red;" runat="server" onserverclick="cmdExportOQCACL_ServerClick" />
                                    </td>
                                </tr>
                            </table>
                        </td>
