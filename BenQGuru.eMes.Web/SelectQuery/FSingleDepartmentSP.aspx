<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSingleDepartmentSP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleDepartmentSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblSelectTitle" runat="server">选择部门 (单选)</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtDepCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
