<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSingleRes.aspx.cs" Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleRes" %>
        ...
        <tr>
            <td>
                <div style="display: none">
                    <input id="cmdInit" type="button" value="init" name="cmdInit" runat="server"><textarea
                        id="txtSelected" rows="1" cols="20" runat="server" name="txtSelected"></textarea>
                </div>
            </td>
        </tr>
    </table>
