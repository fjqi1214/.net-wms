<%@ Page Language="c#" CodeBehind="FReworkMOSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FReworkMOSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblReturnNeedTitle" runat="server">返工需求单选择</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    ...
                    <tr>
                        ...
                        <td nowrap class="fieldValue">
                            <asp:TextBox ID="txtReworkSheetQuery" runat="server" CssClass="textbox" Width="150px"></asp:TextBox>
                        </td>
                        <td>
                        </td>
                        <td class="fieldName">
