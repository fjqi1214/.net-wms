<%@ Page Language="c#" CodeBehind="FCommonMultiSP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FCommonMultiSP" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblCodeQuery" runat="server">代码</asp:Label>
                        </td>
