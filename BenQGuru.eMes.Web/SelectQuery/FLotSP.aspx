<%@ Page Language="c#" CodeBehind="FLotSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FLotSP" %>
            ...
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtLotNoQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
