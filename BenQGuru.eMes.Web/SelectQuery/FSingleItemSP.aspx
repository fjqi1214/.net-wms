<%@ Page Language="c#" CodeBehind="FSingleItemSP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleItemSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblItemTitle" runat="server">选择产品 (单选)</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="texItemDescQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
