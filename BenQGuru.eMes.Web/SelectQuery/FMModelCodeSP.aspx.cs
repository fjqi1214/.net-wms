...
namespace BenQGuru.eMES.Web.SelectQuery
{
    ...
    /// Selector 的摘要说明。
    /// </summary>
    public partial class FMModelCodeSP : BaseSelectorPageNew
    {
        ...
        protected override DataRow GetSelectedGridRow(object obj)
        {
            ...
            row["Selector_SelectedCode"] = ((BenQGuru.eMES.Domain.MOModel.Material)obj).ModelCode;
        ...
        protected override DataRow GetUnSelectedGridRow(object obj)
        {
            ...
            row["Selector_UnselectedCode"] = ((BenQGuru.eMES.Domain.MOModel.Material)obj).ModelCode;
