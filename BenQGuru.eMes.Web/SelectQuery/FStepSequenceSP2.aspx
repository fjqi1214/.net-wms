<%@ Page Language="c#" CodeBehind="FStepSequenceSP2.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FStepSequenceSP2" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtSegmentCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap class="fieldName">
                            <asp:Label ID="lblStepSequenceCodeQuery" runat="server">生产线代码</asp:Label>
                        </td>
                        <td nowrap class="fieldValue">
                            <asp:TextBox ID="txtStepSequenceCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap class="fieldName">
                        </td>
                        <td nowrap class="fieldValue">
