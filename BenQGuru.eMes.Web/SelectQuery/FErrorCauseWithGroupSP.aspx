<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FErrorCauseWithGroupSP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FErrorCauseWithGroupSP" %>
...
<head>
    <title>FErrorCauseWithGroupSP</title>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblErrorCauseCodeQuery" runat="server">不良原因代码</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtErrorCauseCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblErrorCauseDescriptionEdit" runat="server">不良原因描述</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtErrorCauseDescriptionEdit" runat="server" CssClass="textbox"
                    ...
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblErrorCauseGroupQuery" runat="server">不良原因组</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtErrorCauseGroupQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblErrorCauseGroupDescriptionEdit" runat="server">不良原因组描述</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtErrorCauseGroupDescriptionEdit" runat="server" CssClass="textbox"
                                Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
        ...
        <tr>
            <td>
                <div style="display: none">
                    <input type="button" value="init" id="cmdInit" runat="server">
