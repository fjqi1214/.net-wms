<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMmachinetypeSP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FMmachinetypeSP" %>
        ...
        <tr>
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" visible="false" nowrap>
                            <asp:Label ID="lblMaterialMachineTypeGroup" runat="server">工段代码</asp:Label>
                        </td>
                        <td class="fieldValue" visible="false" nowrap>
                            <asp:TextBox ID="txtMaterialMachineTypeGroup" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
