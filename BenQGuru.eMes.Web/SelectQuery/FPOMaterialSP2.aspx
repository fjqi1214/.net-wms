<%@ Page Language="c#" CodeBehind="FPOMaterialSP2.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FPOMaterialSP2" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td nowrap="noWrap" class="fieldName">
                            <asp:Label ID="lblPOQuery" runat="server">PO单号</asp:Label>
                        </td>
                        <td nowrap="noWrap" class="fieldValue">
                            <asp:TextBox ID="txtPOQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap="noWrap" class="fieldName">
