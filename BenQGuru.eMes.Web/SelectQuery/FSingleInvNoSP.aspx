<%@ Page Language="c#" CodeBehind="FSingleInvNoSP.aspx.cs" AutoEventWireup="True"  Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleInvNoSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblFSingleInvNoSP" runat="server">预留单介面</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
