<%@ Page Language="c#" CodeBehind="FReMOSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FReMOSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblReturnMOTitle" runat="server">返工工单选择</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
