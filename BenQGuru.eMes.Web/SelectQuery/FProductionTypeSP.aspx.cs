...
namespace BenQGuru.eMES.Web.SelectQuery
{
    ...
    /// Selector 的摘要说明。
    /// </summary>
    public partial class FProductionTypeSP : BaseSelectorPageNew
    {
        ...
        protected override object[] LoadSelectedDataSource(int inclusive, int exclusive)
        {
            ...
            return this.facade.QuerySelectedProductionType(this.GetSelectedCodes());
        }
        ...
        {
            if (facade == null) { facade = new FacadeFactory(base.DataProvider).CreateSPFacade(); }
            return this.facade.QueryUNSelectProductionType(this.GetSelectedCodes(), inclusive, exclusive);
        }
