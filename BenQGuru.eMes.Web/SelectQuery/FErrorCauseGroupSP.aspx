<%@ Page Language="c#" CodeBehind="FErrorCauseGroupSP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FErrorCauseGroupSP" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblErrorCauseGroupCodeQuery" runat="server">不良原因组代码</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtErrorCauseGroupCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
