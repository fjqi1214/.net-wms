<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSingleDutyCodeSP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleDutyCodeSP" %>
            ...
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtDutyCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblDutyDescriptionQuery" runat="server">责任别描述</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtDutyCodeDESCQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
