<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FStorageTypeSP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FStorageTypeSP" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblStorageTypeEdit" runat="server">库别代码</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtStorageTypeEdit" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblStorageDescEdit" runat="server">库别名称</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtStorageDescEdit" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
