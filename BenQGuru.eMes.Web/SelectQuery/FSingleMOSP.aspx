<%@ Page Language="c#" CodeBehind="FSingleMOSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleMOSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblMOTitle" runat="server">选择工单 (单选)</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
