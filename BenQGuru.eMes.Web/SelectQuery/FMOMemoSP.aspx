<%@ Page Language="c#" CodeBehind="FMOMemoSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FMOMemoSP" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblMOMemoQuery" runat="server">工段代码</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtMOMemoQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
