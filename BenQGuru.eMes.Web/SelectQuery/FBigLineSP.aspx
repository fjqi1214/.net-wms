<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FBigLineSP.aspx.cs" Inherits="BenQGuru.eMES.Web.SelectQuery.FBigLineSP" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue" style="height: 26px">
                            <asp:TextBox ID="txtBIGLine" runat="server" CssClass="textbox" Width="130px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
