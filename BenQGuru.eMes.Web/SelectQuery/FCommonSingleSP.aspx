<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FCommonSingleSP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FCommonSingleSP" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblCodeQuery" runat="server">工段代码</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
