<%@ Page Language="c#" CodeBehind="FSingleWWpoInvNoSP.aspx.cs" AutoEventWireup="True"  Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleWWpoInvNoSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblFSingleInvNoMaterialSP" runat="server">预留单介面</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
