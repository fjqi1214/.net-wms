...
namespace BenQGuru.eMES.Web.SelectQuery
{
    ...
    /// Selector 的摘要说明。
    /// </summary>
    public partial class FInspectorSP : BaseSelectorPageNew
    {
        ...
        protected override DataRow GetSelectedGridRow(object obj)
        {
            ...
            row["Selector_SelectedCode"] = ((IQCHeadWithInspectorName)obj).Inspector;
            row["Selector_SelectedDesc"] = ((IQCHeadWithInspectorName)obj).UserName;
            return row;
        }
        ...
        protected override DataRow GetUnSelectedGridRow(object obj)
        {
            ...
            row["Selector_UnselectedCode"] = ((IQCHeadWithInspectorName)obj).Inspector;
            row["Selector_UnSelectedDesc"] = ((IQCHeadWithInspectorName)obj).UserName;
            return row;
        }
        ...
        protected override object[] LoadSelectedDataSource(int inclusive, int exclusive)
        {
            ...
            return this.facade.QuerySelectedInspector(this.GetSelectedCodes());
        }
