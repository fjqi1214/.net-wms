<%@ Page Language="c#" CodeBehind="FInvNoSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FInvNoSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblSelectTitle" runat="server">预留单</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblYLInvNoQuery" runat="server">预留单号</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtYLInvNoQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblContactQuery" runat="server">联系人</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtContactQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                         <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblStorageQuery" runat="server">库位</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtStorageQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
        ...
        <tr>
            <td nowrap>
                <table id="Table3" cellpadding="0" width="100%">
                    <tr>
                        <td>
        ...
        <tr>
            <td nowrap align="center">
                ...
                <asp:Button ID="cmdUnSelect" Style="background-image: url(../Skin/Image/up.gif)"
                    runat="server" CssClass="smallbutton"></asp:Button>
            </td>
        </tr>
        <tr>
