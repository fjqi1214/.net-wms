<%@ Page Language="c#" CodeBehind="FResourceSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FResourceSP" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtSegmentCodeQuery" runat="server" Width="120px" CssClass="textbox"></asp:TextBox>
                        </td>
                        <td nowrap class="fieldName">
                            <asp:Label ID="lblStepSequenceCodeQuery" runat="server">生产线代码</asp:Label>
                        </td>
                        <td nowrap class="fieldValue">
                            <asp:TextBox ID="txtStepSequenceCodeQuery" runat="server" Width="120px" CssClass="textbox"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtOPCodeQuery" runat="server" Width="120px" CssClass="textbox"></asp:TextBox>
                        </td>
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblResourceCodeQuery" runat="server">资源代码</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtResourceCodeQuery" runat="server" Width="120px" CssClass="textbox"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                        </td>
                        <td class="fieldName">
