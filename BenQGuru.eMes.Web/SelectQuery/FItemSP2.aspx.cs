...
namespace BenQGuru.eMES.Web.SelectQuery
{
	...
	/// Selector 的摘要说明。
	/// </summary>
	public partial class FItemSP2 : BaseSelectorPageNew
	{
        ...
        protected override DataRow GetSelectedGridRow(object obj)
        {
            ...
            row["Selector_SelectedCode"] = ((BenQGuru.eMES.Domain.MOModel.Item)obj).ItemCode;
            row["Selector_SelectedDesc"] = ((BenQGuru.eMES.Domain.MOModel.Item)obj).ItemDescription;
            return row;
        }
        ...
        protected override DataRow GetUnSelectedGridRow(object obj)
        {
            ...
            row["Selector_UnselectedCode"] = ((BenQGuru.eMES.Domain.MOModel.Item)obj).ItemCode;
            row["Selector_UnSelectedDesc"] = ((BenQGuru.eMES.Domain.MOModel.Item)obj).ItemDescription;
            return row;
        }
