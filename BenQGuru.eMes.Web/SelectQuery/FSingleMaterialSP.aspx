<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSingleMaterialSP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleMaterialSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblSelectTitle" runat="server">选择物料 (单选)</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
