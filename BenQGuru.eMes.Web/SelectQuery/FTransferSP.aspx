<%@ Page Language="c#" CodeBehind="FTransferSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FTransferSP" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblTransferNO" runat="server">FTransferSP</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtTransferNO" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
