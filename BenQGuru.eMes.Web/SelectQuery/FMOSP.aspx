<%@ Page Language="c#" CodeBehind="FMOSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FMOSP" %>
            ...
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="fieldName" visible="false">
                            <asp:Label ID="lblFactory" runat="server" Visible="False">工厂</asp:Label>
                        </td>
                        <td class="fieldValue" visible="false">
                            <asp:DropDownList ID="drpFactory" runat="server" Width="150px" Visible="False">
                            </asp:DropDownList>
                        </td>
                        <td>
                        </td>
