<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FInspectorSP.aspx.cs" Inherits="BenQGuru.eMES.Web.SelectQuery.FInspectorSP" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblInspectorEdit" runat="server">检验员</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtInspectorEdit" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblInspectorEditName" runat="server">检验员名字</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtInspectorEditName" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
