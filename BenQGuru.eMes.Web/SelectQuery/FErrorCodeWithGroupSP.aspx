<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FErrorCodeWithGroupSP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FErrorCodeWithGroupSP" %>
...
<head>
    <title>FErrorCodeWithGroupSP</title>
            ...
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtNGCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblErrorDescriptionQuery" runat="server">不良代码描述</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtErrorDescriptionQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblErrorCodeGroupEdit" runat="server">不良代码组代码</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtErrorCodeGroupEdit" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblErrorCodeGroupDescriptionEdit" runat="server">不良代码组描述</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtErrorCodeGroupDescriptionEdit" runat="server" CssClass="textbox"
