<%@ Page Language="c#" CodeBehind="FShelfSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FShelfSP" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblShelfNOQuery" runat="server">车号</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtShelfNoQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldName" style="display: none" nowrap>
                            <asp:Label ID="lblItemCodeQuery" runat="server">产品代码</asp:Label>
                        </td>
                        <td class="fieldValue" style="display: none" nowrap>
