<%@ Page Language="c#" CodeBehind="FStackSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FStackSP" %>
                ...
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblStackCodeQuery" runat="server">垛位代码</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtStackCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
