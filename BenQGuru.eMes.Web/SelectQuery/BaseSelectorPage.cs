...
namespace BenQGuru.eMES.Web.Helper
{
    ...
    /// Selector 的摘要说明。
    /// </summary>
    public class BaseSelectorPage : BasePage
    {
        ...
        protected virtual void SetSelectedCodes()
        {
            ...
            {
                key = this.gridSelectedHelper.Grid.Rows[i].Cells[1].Text;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if(!writerOutted)
            {
                ...
                writer.Write("<script language=javascript>try{if(window.top.valueLoaded != true){document.getElementById('txtSelected').innerText = window.top.dialogArguments.Codes;if(document.getElementById('txtOthers') !=null ){document.getElementById('txtOthers').innerText = window.top.dialogArguments.Others;}document.getElementById('cmdInit').click();window.top.valueLoaded = true ;}}catch(e){};</script>");
            }
        }
