<%@ Page Language="c#" CodeBehind="FASNSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FASNSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblFASNSP" runat="server">选择ASN号</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                 <tr>
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblASNCodeQuery" runat="server">ASN号</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtASNCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblVendorCodeQuery" runat="server">供应商代码</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtVendorCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                  
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblStorageCodeQuery" runat="server">入库库位</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtStorageCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
