<%@ Page Language="c#" CodeBehind="FErrorCodeSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FErrorCodeSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblNGSelectTitle" runat="server">不良代码选择</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
                <table class="query" id="Table2" height="40" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:DropDownList ID="drpModelEdit" runat="server" CssClass="require" Width="120px"
                                AutoPostBack="True" OnLoad="drpModelEdit_Load" OnSelectedIndexChanged="drpModelEdit_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                        ...
                        <td class="fieldValue">
                            <asp:DropDownList ID="drpErrorCodeGroupEdit" runat="server" CssClass="require" Width="120px">
                            </asp:DropDownList>
                        </td>
                        <td class="fieldNameLeft" nowrap style="display: none">
                            <asp:Label ID="lbErrorCodeEdit" runat="server">不良代码</asp:Label>
                        </td>
                        <td class="fieldValue" style="display: none">
                            <asp:DropDownList ID="drpErrorCodeEdit" runat="server" CssClass="require" Width="120px">
                            </asp:DropDownList>
                        </td>
                        <td class="fieldName">
