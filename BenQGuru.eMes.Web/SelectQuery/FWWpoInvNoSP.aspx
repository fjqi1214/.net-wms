<%@ Page Language="c#" CodeBehind="FWWpoInvNoSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FWWpoInvNoSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblFWWpoInvNoSP" runat="server">预留单介面</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
                 ...
                 <tr>
                      <td class="fieldNameLeft" nowrap>
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtYLInvNoQuery" runat="server" CssClass="textbox" Width="120px" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblDQMoCodeQuery" runat="server">鼎桥物料编码</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtDQMoCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                           <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblMaterialDescQuery" runat="server"> 物料描述</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap  >
                            <asp:TextBox ID="txtMaterialDescQuery" runat="server" CssClass="textbox" Width="120px"  ></asp:TextBox>
                        </td>
