<%@ Page Language="c#" CodeBehind="FDepartmentSP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FDepartmentSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblSelectTitle" runat="server">选择部门</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtDepCodeQuery" runat="server" Width="120px" CssClass="textbox"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
        ...
        <tr>
            <td nowrap align="center">
                <asp:Button ID="cmdSelect" runat="server" Style="background-image: url(../Skin/Image/down.gif)"
                    CssClass="smallbutton"></asp:Button>&nbsp;<asp:Button ID="cmdUnSelect" runat="server"
                        Style="background-image: url(../Skin/Image/up.gif)" CssClass="smallbutton">
                </asp:Button>
            </td>
        </tr>
        <tr>
