...
namespace BenQGuru.eMES.Web.Helper
{
    ...
    /// Selector 的摘要说明。
    /// </summary>
    public class BaseSingleSelectorPageNew : BasePageSelectNew
    {
...
//        function SelectGrid_Initialize(sender, e) {
//            Grid_Initialize(sender,e);
//            $(sender._header).find('img').hide();
//        }
        ...
        {
            base.InitWebGrid();
            this.gridUnSelectedHelper.AddCheckBoxColumn(this.gridUnSelectedHelper.CheckColumnKey, "", false);
