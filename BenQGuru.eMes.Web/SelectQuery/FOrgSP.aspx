<%@ Page Language="c#" CodeBehind="FOrgSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FOrgSP" %>
        ...
        <tr>
            <td>
                <div style="display: none">
                    <textarea id="txtSelected" rows="1" cols="20" runat="server" name="txtSelected"></textarea><textarea
                        id="txtOthers" rows="1" cols="20" runat="server" name="txtOthers"></textarea><input
                            type="button" value="init" id="cmdInit" runat="server" name="cmdInit">
                </div>
            </td>
        </tr>
    </table>
