<%@ Page Language="c#" CodeBehind="FItemSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FItemSP" %>
            ...
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtItemDescQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
