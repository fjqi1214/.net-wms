<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSingleOPSP.aspx.cs" Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleOPSP" %>
        ...
        <tr>
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        <td class="fieldNameLeft" nowrap id="tdRouteLabel" runat="server">
                            <asp:Label ID="lblRouteCodeQuery" runat="server">生产途程代码</asp:Label>
                        </td>
                        <td class="fieldValue" nowrap id="tdRouteEdit" runat="server">
                            <asp:TextBox ReadOnly="true" ID="txtRouteCodeQuery" runat="server" CssClass="textbox"
                        ...
                        <td class="fieldValue" nowrap>
                            <asp:TextBox ID="txtOPCodeQuery" runat="server" CssClass="textbox" Width="120px"></asp:TextBox>
                        </td>
                        <td nowrap width="100%">
                            &nbsp;
                        </td>
        ...
        <tr>
            <td>
                <div style="display: none">
                    ...
                    <asp:CheckBox ID="chbUnSelected" runat="server" AutoPostBack="True"></asp:CheckBox><input
                        id="cmdInit" type="button" value="init" name="cmdInit" runat="server">
