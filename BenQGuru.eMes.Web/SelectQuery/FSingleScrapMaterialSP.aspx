<%@ Page Language="c#" CodeBehind="FSingleScrapMaterialSP.aspx.cs" AutoEventWireup="True"  Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleScrapMaterialSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblFSingleScrapMaterialSP" runat="server">预留单介面</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
