<%@ Page Language="c#" CodeBehind="FSymptomSP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.SelectQuery.FSymptomSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblSelNGTitle" runat="server">选择不良现象</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
