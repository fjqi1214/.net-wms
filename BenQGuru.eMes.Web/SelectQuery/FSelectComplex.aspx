<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSelectComplex.aspx.cs"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FSelectComplex" %>
                    ...
                    <table class="query" id="Table2" height="100%" width="100%">
                        <tr>
                            <td class="fieldNameLeft" nowrap>
                                <asp:Label ID="lblQueryCodeQuery" runat="server">数据查询</asp:Label>
                            </td>
                            <td class="fieldValue" nowrap>
                                <asp:TextBox ID="txtQueryCodeQuery" runat="server" Width="120px" CssClass="textbox"></asp:TextBox>
                            </td>
                            <td nowrap class="fieldName">
                                <asp:Label ID="lblQueryDescQuery" runat="server">数据描述</asp:Label>
                            </td>
                            <td nowrap class="fieldValue">
                                <asp:TextBox ID="txtQueryDescQuery" runat="server" Width="120px" CssClass="textbox"></asp:TextBox>
                            </td>
                            <td nowrap width="100%">
                                &nbsp;
                            </td>
