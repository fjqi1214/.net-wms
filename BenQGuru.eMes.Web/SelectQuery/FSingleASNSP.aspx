<%@ Page Language="c#" CodeBehind="FSingleASNSP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleASNSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblFSingleASNSP" runat="server">选择ASN号(单选)</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
