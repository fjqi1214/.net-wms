<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSingleReworkCodeSP.aspx.cs"
    Inherits="BenQGuru.eMES.Web.SelectQuery.FSingleReworkCodeSP" %>
...
<body>
    ...
    <table id="Table1" height="100%" cellspacing="1" cellpadding="1" width="100%" border="0"
        ...
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblSelectReworkCodeTitle" runat="server">选择返工需求单 (单选)</asp:Label>
            </td>
        </tr>
        <tr>
            <td nowrap>
                <table class="query" id="Table2" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtReworkSheetCode" runat="server" CssClass="textbox" Width="150px"></asp:TextBox>
                        </td>
                        <td style="width: 100%">
                        </td>
                        <td class="fieldName">
