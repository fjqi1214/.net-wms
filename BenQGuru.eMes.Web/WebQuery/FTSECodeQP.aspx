...
<%@ Page language="c#" Codebehind="FTSECodeQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FTSECodeQP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td>
						<asp:label id="lblTitle" runat="server" CssClass="labeltopic">维修不良率分析</asp:label>
					</td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							...
							<tr>
								...
								<td class="fieldValue">
                                <asp:TextBox  id="dateStartDateQuery"  class='datepicker require' runat="server"  Width="110px"/>
								</td>
								<td class="fieldName" noWrap>
									<asp:label id="lblEndDateQuery" runat="server">结束日期</asp:label>
								</td>
								<td class="fieldValue">
                                 <asp:TextBox  id="dateEndDateQuery"  class='datepicker require' runat="server"  Width="110px"/>
								</td>
