<%@ Page language="c#" Codebehind="FOQCFuncValueDataQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FOQCFuncValueDataQP" %>
...
<HTML>
	<HEAD>
		<title>FOQCFuncValueDataQP</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" height="100%" width="100%">
				<TR class="moduleTitle">
					<TD>
						<asp:Label id="lblTitle" runat="server">功能测试数据</asp:Label><INPUT class="textbox" id="txtSeq" style="DISPLAY: none; WIDTH: 120px" readOnly name="textfield"
							runat="server"><INPUT id="txtLotSeq" type="hidden" name="Hidden2" runat="server"><INPUT id="txtLotNo" type="hidden" name="Hidden1" runat="server"></TD>
				</TR>
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
				...
				<TR>
					<TD>
						<asp:label id="lblSizeTitle1" runat="server" CssClass="labeltopic">尺寸量测数据</asp:label></TD>
				</TR>
				<TR>
					<TD class="fieldGrid" height="75%">
						<igtbl:ultrawebgrid id="gridSN" runat="server" Height="100%" Width="100%">
							<DisplayLayout ColWidthDefault="" StationaryMargins="Header" AllowSortingDefault="Yes" RowHeightDefault="20px"
								Version="2.00" SelectTypeRowDefault="Single" SelectTypeCellDefault="Single" HeaderClickActionDefault="SortSingle"
								BorderCollapseDefault="Separate" AllowColSizingDefault="Free" CellPaddingDefault="4" RowSelectorsDefault="No"
