<%@ Page Language="c#" CodeBehind="FOnWipDistributingQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FOnWipDistributingQP" %>
...
<html>
<head>
    <title>FOnWipDistributingQP</title>
...
<body ms_positioning="GridLayout">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">在制明细</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtResourceCodeQuery" runat="server" CssClass="textbox" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblMOIDQuery" runat="server">工单代码</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtMoCodeQuery" runat="server" CssClass="textbox" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td width="100%">
                        </td>
                    </tr>
