<%@ Page language="c#" Codebehind="FRealTimeQuantityDetails.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FRealTimeQuantityDetails" %>
					...
					<td>
						<table class="query" height="100%" width="100%">
							...
							<tr>
								...
								<td class="fieldValue"><asp:textbox id="txtStepSeqenceCodeQuery" runat="server" CssClass="textbox" ReadOnly="True" Width="120px"></asp:textbox></td>
								<td class="fieldName" noWrap><asp:label id="lblTpCode" runat="server">时段</asp:label></td>
								<td class="fieldValue">
										<asp:textbox id="txtTimePeriodDetail" runat="server" CssClass="textbox" ReadOnly="True" Width="120px"></asp:textbox></td>
								<td></td>
								<td width="100%"></td>
							</tr>
						</table>
