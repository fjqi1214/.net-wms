...
<%@ Page language="c#" Codebehind="FOutMaterialQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FOutMaterialQP" %>
					...
					<td>
						<table class="query" id="Table2" height="100%" width="100%">
							<TR>
								...
								<td class="fieldNameLeft" noWrap><asp:label id="lblItemConditionQuery" runat="server">料件号</asp:label></td>
