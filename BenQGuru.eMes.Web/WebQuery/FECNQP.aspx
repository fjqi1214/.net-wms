<%@ Page language="c#" Codebehind="FECNQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FECNQP" %>
			...
			<table height="100%" width="100%" id="Table1">
				<tr class="moduleTitle">
					<td style="HEIGHT: 19px">
						<asp:label id="lblTitle" runat="server" CssClass="labeltopic">ECN起始序列号查询</asp:label>
					</td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%" id="Table2">
							...
							<tr>
								...
								<td class="fieldName" noWrap>
									<asp:label id="lblECN" runat="server">ECN单号</asp:label>
								</td>
								<td class="fieldValue">
									<asp:TextBox id="txtECNQuery" runat="server" CssClass="textbox"></asp:TextBox>
								</td>
								<td class="fieldName">
