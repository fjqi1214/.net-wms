...
<%@ Page language="c#" Codebehind="FECNDetailsQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FECNDetailsQP" %>
			...
			<table height="100%" width="100%" id="Table1">
				<tr class="moduleTitle">
					<td style="HEIGHT: 19px">
						<asp:label id="lblTitle" runat="server" CssClass="labeltopic">ECN产品明细</asp:label>
					</td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%" id="Table2">
							<TR>
								...
								<td class="fieldValue">
									<asp:TextBox id="txtECNQuery" runat="server" CssClass="textbox" ReadOnly="True"></asp:TextBox>
								</td>
								<td width="100%"></td>
							</TR>
						</table>
