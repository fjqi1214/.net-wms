<%@ Page Language="c#" CodeBehind="FITProductionProcessQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FITProductionProcessQP" %>
...
<body>
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server">生产过程</asp:Label><input class="textbox" id="txtSeq"
