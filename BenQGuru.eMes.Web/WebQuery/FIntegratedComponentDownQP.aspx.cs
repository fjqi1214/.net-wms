...
namespace BenQGuru.eMES.Web.WebQuery
{
	...
	/// </summary>
	public partial class FIntegratedComponentDownQP : BaseQPage
	{
		...
		private void _initialWebGrid()
		{
            ...
            this._gridHelper.AddColumn("PackedNo", "最小包装条码", null);
			...
			this._gridHelper.AddLinkColumn("ComponentLoadingDetails1","下料明细",null);
		...
		private void _helper_DomainObjectToGridRow(object sender, EventArgs e)
		{
			...
			{
				QDOIntegrated obj = ( e as DomainObjectToGridRowEventArgs ).DomainObject as QDOIntegrated;
		...
		private void _helper_DomainObjectToExportRow(object sender, EventArgs e)
		{
			...
			{
				QDOIntegrated obj = ( e as DomainObjectToExportRowEventArgs ).DomainObject as QDOIntegrated;
		...
		{
			if( (e as GridCellClickEventArgs).Cell.Column.Key.ToUpper() == "ComponentLoadingDetails1".ToUpper() )
			{
				this.Response.Redirect( 
					...
					new string[]{
									(e as GridCellClickEventArgs).Cell.Row.Cells.FromKey("PackedNo").Text,
									"FIntegratedComponentDownQP.aspx"
								})
					);
			}
		}			
