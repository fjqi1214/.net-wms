<%@ Page language="c#" Codebehind="FOutWIPQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FOutWIPQP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table id="Table1" height="100%" width="100%">
				<tr class="moduleTitle">
					<td style="HEIGHT: 19px"><asp:label id="lblTitle" runat="server" CssClass="labeltopic">外包生产过程查询</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" id="Table2" height="100%" width="100%">
							<TR>
								<td class="fieldNameLeft" noWrap><asp:label id="lblItemStuffQuery" runat="server">产品料号</asp:label></td>
								<td class="fieldValue"><asp:textbox id="txtConditionItem" runat="server" CssClass="textbox" Width="130"></asp:textbox></td>
