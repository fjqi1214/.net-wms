...
<%@ Page language="c#" Codebehind="FOQCFuncValueQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FOQCFuncValueQP" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>FOQCFuncValueQP</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" height="100%" width="100%">
				<TR class="moduleTitle">
					<TD>
						<asp:Label id="lblTitle" runat="server">功能测试信息</asp:Label><INPUT class="textbox" id="txtSeq" style="DISPLAY: none; WIDTH: 120px" readOnly name="textfield"
...
<BorderDetails ColorTop="White" WidthLeft="1px" WidthTop="1px" ColorLeft="White">
				...
				<TR>
					<TD>
						<asp:label id="lblSizeInfoTitle" runat="server" CssClass="labeltopic">尺寸量测信息</asp:label></TD>
				</TR>
				<TR>
