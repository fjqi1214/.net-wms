...
namespace BenQGuru.eMES.Web.WebQuery
{
	...
	/// </summary>
	public partial class FTSRecordDetailsQP : BaseQPageNew
	{
		...
		private void _initialWebGrid()
		{
            ...
            this.gridHelper.AddColumn("ErrorCauseGroupCode", "不良原因组", null);
			this.gridHelper.AddColumn("ErrorCause",			"不良原因",null);
			this.gridHelper.AddColumn( "ErrorLocation",		"不良位置",	null);
            this.gridHelper.AddColumn("ErrorComponent", "不良组件", null);
            ...
            this.gridHelper.AddColumn("SolutionMemo", "预防措施", null);
