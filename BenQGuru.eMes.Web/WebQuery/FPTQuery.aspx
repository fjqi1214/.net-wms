<%@ Page language="c#" Codebehind="FPTQuery.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FPTQuery" %>
		...
		<form id="Form1" method="post" runat="server">
			<table id="Table1" height="100%" width="100%">
				<tr class="moduleTitle">
					<td style="HEIGHT: 19px"><asp:label id="lblTitle" runat="server" CssClass="labeltopic">PT测试结果查询</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" id="Table2" height="100%" width="100%">
							...
							<tr>
								...
								<TD class="fieldValue" noWrap>
									<uc1:emesdate id="txtBeginDate" runat="server" width="80" CssClass="require"></uc1:emesdate></TD>
								<td class="fieldName" noWrap><asp:label id="lblEndDateQuery" runat="server">结束日期</asp:label></td>
								<TD class="fieldValue" noWrap>
									<uc1:emesdate id="txtEndDate" runat="server" width="80" CssClass="require"></uc1:emesdate>
								</TD>
								<td></td>
