...
<%@ Page Language="c#" CodeBehind="FITOPResultTestingQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FITOPResultTestingQP" %>
...
<body>
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        ...
        <tr>
            <td>
                <asp:Label ID="lblNGInfoTitle" runat="server" CssClass="labeltopic">不良信息</asp:Label>
            </td>
        </tr>
        <tr height="50%">
            <td class="fieldGrid">
