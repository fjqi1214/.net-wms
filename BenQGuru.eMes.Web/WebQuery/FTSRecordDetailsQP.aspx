<%@ Page Language="c#" CodeBehind="FTSRecordDetailsQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FTSRecordDetailsQP" %>
    ...
    <table height="100%" width="100%" id="Table1" runat="server">
        <tr class="moduleTitle">
            <td style="height: 19px">
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">维修详细信息</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
