<%@ Page language="c#" Codebehind="FIntegratedComponentDownQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FIntegratedComponentDownQP" %>
			...
			<table height="100%" width="100%" id="Table1">
				<tr class="moduleTitle">
					<td style="HEIGHT: 19px">
						<asp:label id="lblTitle" runat="server" CssClass="labeltopic">产品集成下料查询</asp:label>
					</td>
				</tr>
				<tr>
					<td>
