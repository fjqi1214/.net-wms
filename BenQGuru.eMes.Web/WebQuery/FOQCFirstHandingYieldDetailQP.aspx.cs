...
namespace BenQGuru.eMES.Web.WebQuery
{
	...
	public partial class FOQCFirstHandingYieldDetailQP  : BaseMPage
	{
		...
		{
			this.gridHelper.AddColumn( "LOTNO1", "抽检批号",	null);
			this.gridHelper.AddColumn( "LOTSIZE", "批量",	null);
			this.gridHelper.AddColumn( "PlanSIZE", "计划抽检样本数",	null);
			this.gridHelper.AddColumn( "ActCheckSIZE", "实际抽检样本数",	null);
			this.gridHelper.AddColumn( "AGRADETIMES", "A等级",	null);
			this.gridHelper.AddColumn( "BGGRADETIMES", "B等级",	null);
			this.gridHelper.AddColumn( "CGRADETIMES", "C等级",	null);
            this.gridHelper.AddColumn( "ZGRADETIMES", "Z等级", null);
			this.gridHelper.AddColumn( "LOTSTATUS", "判定结果",	null);
			this.gridHelper.AddColumn( "MDATE1", "判定日期",	null);
			this.gridHelper.AddColumn( "MTIME1", "判定时间",	null);
			this.gridHelper.AddColumn( "MUSER1", "操作工",	null);
