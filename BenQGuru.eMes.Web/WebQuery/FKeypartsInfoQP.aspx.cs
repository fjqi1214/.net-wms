...
{
	/// <summary>
	/// FKeypartsInofQP 的摘要说明。
	/// </summary>
	public partial class FKeypartsInfoQP : BaseQPageNew
	{
		...
		private void _initialWebGrid()
		{
			...
			this._gridHelper.AddColumn("Keyparts","单件料序列号",null);
			this._gridHelper.AddColumn("ActionType","交易类型",null);
//			this._gridHelper.AddColumn("CanTrace","可追溯",null);
//			this._gridHelper.AddLinkColumn("Trace","追溯",null);
            ...
            ((BoundDataField)this.gridHelper.Grid.Columns.FromKey("Keyparts")).HtmlEncode = false; 
			//多语言
