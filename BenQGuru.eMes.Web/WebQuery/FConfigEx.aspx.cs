...
namespace BenQGuru.eMES.Web.WebQuery
{
	...
	public partial class FConfigEx : BaseQPage
	{
		...
		private void _initialWebGrid()
		{
			...
			this._gridHelper.AddColumn("ConfigCategory",			"配置大类",null);			
			this._gridHelper.AddColumn("ConfigCode",			"属性",null);
			this._gridHelper.AddColumn("ConfigValue",			"标准值",null);
			this._gridHelper.AddColumn("ErrorValue",			"错误值",null);			
