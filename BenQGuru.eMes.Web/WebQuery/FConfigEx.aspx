<%@ Page language="c#" Codebehind="FConfigEx.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FConfigEx" %>
				...
				<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" height="100%"
					...
					<TR class="moduleTitle">
						<TD style="HEIGHT: 19px">
							<asp:label id="lblSingularityTitle" runat="server" CssClass="labeltopic">配置异常查询</asp:label></TD>
					</TR>
					<TR>
						<TD>
							<TABLE class="query" id="Table2" height="100%" width="100%">
								<TR>
									...
									<TD class="fieldName" noWrap>
										<asp:label id="lblConfigureCode" runat="server">配置码</asp:label></TD>
									<TD class="fieldValue"><asp:TextBox id="txtItemConfig" runat="server" CssClass="textbox"></asp:TextBox></TD>
								...
								<TR>
									...
									<TD class="fieldName" nowrap>
										<asp:label id="lblConfigureListQuery" runat="server">配置大类</asp:label></TD>
									<TD class="fieldValue">
										<asp:TextBox id="txtConfigCode" runat="server" CssClass="textbox"></asp:TextBox>
									</TD>
									<td></td>
									<td></td>
								</TR>
								<TR>
									<TD class="fieldNameLeft" noWrap>
										<asp:label id="lblStartTimeQuery" runat="server">起始时间</asp:label></TD>
									<TD class="fieldValue">
                                    <asp:TextBox  id="dateStartDateQuery"  class='datepicker' runat="server"  Width="110px"/>
									<TD class="fieldName" noWrap>
										<asp:label id="lblEndTimeQuery" runat="server">结束时间</asp:label></TD>
									<TD class="fieldValue">
                                    <asp:TextBox  id="dateEndDateQuery"  class='datepicker' runat="server"  Width="110px"/>
									<TD class="fieldName" noWrap>
										<asp:label id="lblAttribute" runat="server">属性</asp:label></TD>
									<td class="fieldValue">
										<asp:TextBox id="txtConfigValue" runat="server" CssClass="textbox"></asp:TextBox></td>
									<td></td>
