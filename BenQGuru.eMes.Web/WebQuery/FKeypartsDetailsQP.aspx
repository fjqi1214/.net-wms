<%@ Page Language="c#" CodeBehind="FKeypartsDetailsQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FKeypartsDetailsQP" %>
    ...
    <table height="100%" width="100%" id="Table1" runat="server">
        <tr class="moduleTitle">
            <td style="height: 19px">
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">Keyparts上料详细信息查询</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%" id="Table2">
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblKeyparts" runat="server">Keyparts序列号</asp:Label>
                        </td>
                        <td class="fieldValue">
