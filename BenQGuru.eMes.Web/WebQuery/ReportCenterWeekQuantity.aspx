<%@ Page language="c#" Codebehind="ReportCenterWeekQuantity.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.ReportCenterWeekQuantity" %>
<%@ Register TagPrefix="cc1" Namespace="BenQGuru.eMES.Web.Helper" Assembly="BenQGuru.eMES.WebUI.Helper" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ReportCenterWeekQuantity</title>
			...
			<table height="100%" width="100%">
				<TBODY>
					<tr>
						...
						<td class="Title2"><asp:label id="lblWeekQuantityTitle" runat="server">产量报表-->本周产量趋势</asp:label></td>
					</tr>
