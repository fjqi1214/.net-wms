...
<%@ Page Language="c#" CodeBehind="FOQCCardCheckList.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FOQCCardCheckList" %>
    ...
    <table height="100%" width="100%" id="Table1" runat="server">
        <tr class="moduleTitle">
            <td style="height: 19px">
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">检验项目</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%" id="Table2">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtSnQuery" runat="server" CssClass="textbox" Width="165px"></asp:TextBox>
                        </td>
                        <td class="fieldName" nowrap>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtItemCode" runat="server" CssClass="textbox" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblMOIDQuery" runat="server">工单代码</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:TextBox ID="txtMOCode" runat="server" CssClass="textbox" ReadOnly="True"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </td>
