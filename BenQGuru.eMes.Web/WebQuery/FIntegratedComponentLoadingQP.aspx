<%@ Page Language="c#" CodeBehind="FIntegratedComponentLoadingQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FIntegratedComponentLoadingQP" %>
    ...
    <table height="100%" width="100%" id="Table1" runat="server">
        <tr class="moduleTitle">
            <td style="height: 19px">
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">产品集成上料查询</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%" id="Table2">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtMCard" runat="server" CssClass="textbox"></asp:TextBox>
                        </td>
                        <td>
                        </td>
                        <td>
