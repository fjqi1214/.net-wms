<%@ Page Language="c#" CodeBehind="FSolderPasteQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FSolderPasteQP" %>
...
<body ms_positioning="GridLayout">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">锡膏使用记录查询</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <cc2:selectabletextbox id="txtSSQuery" runat="server" Width="130px" Type="stepsequence">
                            </cc2:selectabletextbox>
                        </td>
                        <td class="fieldName" nowrap>
                            <asp:Label ID="lblSPIDQuery" runat="server">锡膏编码</asp:Label>
                        </td>
                        <td class="fieldValue">
                    ...
                    <tr>
                        <td class="fieldNameLeft" nowrap>
                            <asp:Label ID="lblSPStatusQuery" runat="server"> 锡膏状态</asp:Label>
                        </td>
                        <td class="fieldValue">
                            <asp:DropDownList ID="drpSPStatusQuery" runat="server" CssClass="textbox" Width="130px">
                            </asp:DropDownList>
                        </td>
                        <td class="fieldName" nowrap>
