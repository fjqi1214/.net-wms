<%@ Page Language="c#" CodeBehind="FOQCLotDetailsListInfoQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FOQCLotDetailsListInfoQP" %>
    ...
    <table height="100%" width="100%" id="Table1" runat="server">
        <tr class="moduleTitle">
            <td style="height: 19px">
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">产品明细查询</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%" id="Table2">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <asp:TextBox ID="txtOQCLotQuery" runat="server" CssClass="textbox" ReadOnly="True"></asp:TextBox>
                        </td>
                        <td width="100%">
                        </td>
                    </tr>
