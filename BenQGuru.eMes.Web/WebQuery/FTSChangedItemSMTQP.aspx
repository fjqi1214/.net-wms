<%@ Page language="c#" Codebehind="FTSChangedItemSMTQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FTSChangedItemSMTQP" %>
			...
			<table height="100%" width="100%" id="Table1">
				<tr class="moduleTitle">
					<td style="HEIGHT: 19px">
						<asp:label id="lblTitle" runat="server" CssClass="labeltopic">SMT换料信息</asp:label>
					</td>
				</tr>
				<tr>
					<td>
