<%@ Page Language="c#" CodeBehind="FRMADefectQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FRMADefectQP" %>
...
<body scroll="yes" ms_positioning="GridLayout">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">RMA不良品查询</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%">
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <asp:RadioButtonList ID="rblSummaryTargetQuery" RepeatColumns="5" runat="server">
                            </asp:RadioButtonList>
                        </td>
                        <td class="fieldName">
