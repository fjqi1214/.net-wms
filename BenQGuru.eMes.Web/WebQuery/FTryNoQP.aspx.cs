...
namespace BenQGuru.eMES.Web.WebQuery
{
	...
	/// FTryNoQP 的摘要说明。
	/// </summary>
	public partial class FTryNoQP : BaseQPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			//this._helper.GridCellClick +=new EventHandler(_helper_GridCellClick); //取消二级界面
		...
		{
			this._gridHelper.AddColumn("TRYNO",			"试流单号",null);
		...
		private void _helper_LoadGridDataSource(object sender, EventArgs e)
		{
			...
			( e as WebQueryEventArgs ).GridDataSource = 
				facadeFactory.CreateQueryTryNoFacade().QueryTryNo(
				...
				FormatHelper.CleanString(this.txtTryNo.Text),
				( e as WebQueryEventArgs ).StartRow,
				( e as WebQueryEventArgs ).EndRow);

			( e as WebQueryEventArgs ).RowCount = 
				facadeFactory.CreateQueryTryNoFacade().QueryTryNoCount(
				FormatHelper.CleanString(this.txtConditionItem.Text).ToUpper(),
				FormatHelper.CleanString(this.txtConditionMo.Text).ToUpper(),
				FormatHelper.CleanString(this.txtConditionModel.Text).ToUpper(),
				FormatHelper.CleanString(this.txtStartSnQuery.Text),
		...
		private void _helper_GridCellClick(object sender, EventArgs e)
		{
			if( (e as GridCellClickEventArgs).Cell.Column.Key.ToUpper() == "Details".ToUpper() )
			{
				this.Response.Redirect( 
					...
					"FTryNoDetailsQP.aspx",
					new string[]{
									"TRYNO"
								},
					new string[]{
									(e as GridCellClickEventArgs).Cell.Row.Cells.FromKey("TRYNO").Text
								})
					);
			}
		}			
