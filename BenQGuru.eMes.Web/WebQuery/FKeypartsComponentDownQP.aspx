<%@ Page language="c#" Codebehind="FKeypartsComponentDownQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FKeypartsComponentDownQP" %>
			...
			<table height="100%" width="100%" id="Table1">
				<tr class="moduleTitle">
					<td style="HEIGHT: 19px">
						<asp:label id="lblTitle" runat="server" CssClass="labeltopic">产品Keyparts下料查询</asp:label>
					</td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%" id="Table2">
							...
							<tr>
								...
								<td class="fieldValue">
									<asp:TextBox id="txtStartKeypartsQuery" runat="server" CssClass="textbox" Width="165px"></asp:TextBox>
								</td>
								<td class="fieldName" noWrap>
									<asp:label id="lblEndKeypartsQuery" runat="server">截止Keyparts序列号</asp:label>
								</td>
								<td class="fieldValue">
									<asp:TextBox id="txtEndKeypartsQuery" runat="server" CssClass="textbox" Width="165px"></asp:TextBox>
								</td>
