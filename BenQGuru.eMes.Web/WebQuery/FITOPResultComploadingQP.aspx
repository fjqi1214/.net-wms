<%@ Page Language="c#" CodeBehind="FITOPResultComploadingQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FITOPResultComploadingQP" %>
...
<body>
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        ...
        <tr>
            <td>
                <asp:Label ID="lblLotInfoTitle" runat="server" CssClass="labeltopic">批控管料信息</asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:Label ID="lblSingleItemInfoTitle" runat="server" CssClass="labeltopic">单件料信息</asp:Label>
            </td>
        </tr>
        <tr>
            <td height="25%" class="fieldGrid">
