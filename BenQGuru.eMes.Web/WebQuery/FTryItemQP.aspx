<%@ Page language="c#" Codebehind="FTryItemQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FTryItemQP" %>
			...
			<table height="100%" width="100%" id="Table1">
				<tr class="moduleTitle">
					<td style="HEIGHT: 19px">
						<asp:label id="lblTitle" runat="server" CssClass="labeltopic">试流物料产品查询</asp:label>
					</td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%" id="Table2">
							<tr>
								<td class="fieldNameLeft" noWrap>
									<asp:label id="lblTryItemQuery" runat="server">试流物料号</asp:label>
								</td>
								<td class="fieldValue">
									<asp:TextBox id="txtTryitemQuery" runat="server" CssClass="require"></asp:TextBox>
								</td>
