...
namespace BenQGuru.eMES.Web.WebQuery
{
	...
	/// </summary>
	public partial class FRealTimeQuantityDetails : BaseQPage
	{
		...
		private void _initialWebGrid()
		{
			...
			this._gridHelper.AddColumn("MoMemo","工单备注",null);
			this._gridHelper.AddColumn("ModelCode","产品别代码",null);
			this._gridHelper.AddColumn("ItemCode","产品代码",null);
			this._gridHelper.AddColumn("ItemName","产品名称",null);
			this._gridHelper.AddColumn("InputQuantity","投入数量",null);
			this._gridHelper.AddColumn("OutputQuantity","产出数量",null);
			this._gridHelper.Grid.Bands[0].ColFootersVisible =ShowMarginInfo.Yes ;
			this._gridHelper.Grid.Columns[4].FooterText = "汇总" ;
			this._gridHelper.Grid.Columns[5].FooterTotal = SummaryInfo.Sum ;
			this._gridHelper.Grid.Columns[6].FooterTotal = SummaryInfo.Sum ;
			this._gridHelper.Grid.Bands[0].FooterStyle.BackColor = this._gridHelper.Grid.Bands[0].HeaderStyle.BackColor;
