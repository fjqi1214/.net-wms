...
{
    public partial class UCParetoChartProcess : System.Web.UI.UserControl
    {
        ...
        private string m_lineLable = null;
        public string LineLable
        {
            get { return m_lineLable; }
            set { m_lineLable = value; }
        }
        ...
        public void DataBind()
        {
            ...
            paretoChart.DataSource = data;
            paretoChart.DataBind();
        }
        ...
        private void DefineChartStyle()
        {
            ...
            {
                this.paretoChart.Axis.X.Extent = DataSource[DataSource.Length - 1].PeriodCode.Length * 35;
                this.paretoChart.Axis.Y.Labels.ItemFormatString = YLabelFormatString;
                this.paretoChart.Axis.Y2.Labels.ItemFormatString = Y2LabelFormatString;
                this.paretoChart.ParetoChart.LineLabel = LineLable;
                this.paretoChart.Data.ZeroAligned = DataType;
                this.paretoChart.Axis.Y.TickmarkStyle = Infragistics.UltraChart.Shared.Styles.AxisTickStyle.Smart;

                if (m_Width != 0)
                {
                    paretoChart.Width = m_Width;
                }

                if (m_Height != 0)
                {
                    paretoChart.Height = m_Height;
                }
            }
        }
        ...
        public DataTable ConvertDataTable()
        {
            ...
            dt.Columns.Add(new DataColumn(columnName[otherIndex].ToString(), typeof(double)));
