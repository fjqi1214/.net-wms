<%@ Page language="c#" Codebehind="FReportCenterMonthPercent.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FReportCenterMonthPercent" %>
<%@ Register TagPrefix="cc1" Namespace="BenQGuru.eMES.Web.Helper" Assembly="BenQGuru.eMES.WebUI.Helper" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>FReportCenterMonthPercent</title>
			...
			<table height="100%" width="100%">
				<TBODY>
					<tr>
						...
						<td class="Title2"><asp:label id="lblMonthYield" runat="server">良率报表-->本月良率趋势</asp:label></td>
					</tr>
