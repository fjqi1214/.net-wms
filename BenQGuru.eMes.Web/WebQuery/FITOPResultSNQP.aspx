...
<%@ Page Language="c#" CodeBehind="FITOPResultSNQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FITOPResultSNQP" %>
...
<body>
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        ...
        <tr>
            <td>
                <asp:Label ID="lblSNTitle" runat="server" CssClass="labeltopic">序号转换信息</asp:Label>
            </td>
        </tr>
        <tr>
            <td class="fieldGrid">
