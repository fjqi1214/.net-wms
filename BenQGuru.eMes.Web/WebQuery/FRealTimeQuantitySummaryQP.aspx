<%@ Page Language="c#" CodeBehind="FRealTimeQuantitySummaryQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FRealTimeQuantitySummaryQP" %>
...
<body ms_positioning="GridLayout">
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">实时产量查询</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
