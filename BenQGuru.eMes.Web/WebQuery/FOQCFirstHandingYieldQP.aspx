...
<%@ Page language="c#" Codebehind="FOQCFirstHandingYieldQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FOQCFirstHandingYieldQP" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" width="100%">
				<tr class="moduleTitle">
					<td><asp:label id="lblTitle" runat="server" CssClass="labeltopic">FQC一次交验合格率</asp:label></td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%">
							<TR>
								...
								<td class="fieldValue">
                                <asp:TextBox  id="dateStartDateQuery"  class='datepicker' runat="server"  Width="150px"/>
                            </td>
								<td class="fieldName" noWrap><asp:label id="lblEndDateQuery" runat="server">结束日期</asp:label></td>
								<td class="fieldValue">
                                <asp:TextBox  id="dateEndDateQuery"  class='datepicker' runat="server"  Width="150px"/>
                                </td>															
