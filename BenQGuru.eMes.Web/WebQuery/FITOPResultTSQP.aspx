...
<%@ Page Language="c#" CodeBehind="FITOPResultTSQP.aspx.cs" AutoEventWireup="True"
    Inherits="BenQGuru.eMES.Web.WebQuery.FITOPResultTSQP" %>
...
<body>
    ...
    <table id="Table1" height="100%" width="100%" runat="server">
        <tr class="moduleTitle">
            <td>
                <asp:Label ID="lblTitle" runat="server">工序结果</asp:Label><input class="textbox" id="txtSeq"
        ...
        <tr>
            <td>
                <asp:Label ID="lblTSTitle" runat="server" CssClass="labeltopic">维修信息</asp:Label>
            </td>
        </tr>
        <tr>
            <td height="25%" class="fieldGrid">
        ...
        <tr>
            <td>
                <asp:Label ID="lblInfoTitle" runat="server" CssClass="labeltopic">换料信息</asp:Label>
            </td>
        </tr>
        <tr>
            <td height="25%" class="fieldGrid">
