<%@ Page language="c#" Codebehind="FTryNoDetailsQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FTryNoDetailsQP" %>
			...
			<table height="100%" width="100%" id="Table1">
				<tr class="moduleTitle">
					<td style="HEIGHT: 19px">
						<asp:label id="lblTitle" runat="server" CssClass="labeltopic">试流产品明细</asp:label>
					</td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%" id="Table2">
							<TR>
								...
								<td class="fieldValue">
									<asp:TextBox id="txtTryNoQuery" runat="server" CssClass="textbox" ReadOnly="True"></asp:TextBox>
								</td>
								<td width="100%"></td>
							</TR>
						</table>
