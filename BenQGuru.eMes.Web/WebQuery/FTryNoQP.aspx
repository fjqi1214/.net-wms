<%@ Page language="c#" Codebehind="FTryNoQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FTryNoQP" %>
			...
			<table height="100%" width="100%" id="Table1">
				<tr class="moduleTitle">
					<td style="HEIGHT: 19px">
						<asp:label id="lblTitle" runat="server" CssClass="labeltopic">试流单明细查询</asp:label>
					</td>
				</tr>
				<tr>
					<td>
						<table class="query" height="100%" width="100%" id="Table2">
							<TR>
								...
								<td>
									<cc2:selectabletextbox id="txtConditionModel" runat="server" Type="model" Width="130px"></cc2:selectabletextbox></td>
								<td></td>
								<td></td>
							</TR>
							<tr>
								...
								<td class="fieldName" noWrap>
									<asp:label id="lblTryItem" runat="server">试流单号</asp:label>
								</td>
								<td class="fieldValue">
									<asp:TextBox id="txtTryNo" runat="server" CssClass="textbox"></asp:TextBox>
								</td>
