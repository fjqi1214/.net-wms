...
namespace BenQGuru.eMES.Web.WebQuery
{
	...
	public partial class FITOPResultPackingQP : BaseMPageNew
	{
        ...
        {
            base.InitWebGrid2();
            this.gridHelper2.AddColumn("IT_CartonNo","包装箱号",null) ;
            this.gridHelper2.AddColumn("IT_Capacity", "包装箱容量", null);
            this.gridHelper2.AddColumn("IT_Collected", "已包装数量", null);
            this.gridHelper2.AddColumn("IT_Memo", "备注", null);
            this.gridHelper2.AddLinkColumn("PackingDetail", "包装明细", null);
		...
		protected override void InitWebGrid3()
		{
			...
			this.gridHelper3.AddColumn("RCard","产品序列号",null) ;
            this.gridHelper3.AddColumn("ItemCode", "产品代码", null);
            this.gridHelper3.AddColumn("MOCode", "工单代码", null);
