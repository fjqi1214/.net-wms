...
{
	/// <summary>
	/// FTimeQuantitySumQP 的摘要说明。
	/// </summary>
	public partial class FTimeQuantitySumQP : BaseQPageNew
	{
		...
		private void _initialWebGrid()
		{
			...
			this.gridHelper.AddColumn("StepSequenceCode","产线",100);
			this.gridHelper.AddColumn("ResourceCode","资源",100);
			this.gridHelper.AddColumn("ActionResult","产出数量",100);
