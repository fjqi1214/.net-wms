<%@ Page Language="c#" CodeBehind="FSMTNGQP.aspx.cs" AutoEventWireup="True" Inherits="BenQGuru.eMES.Web.WebQuery.FSMTNGQP" %>
    ...
    <table height="100%" width="100%" id="Table1" runat="server">
        <tr class="moduleTitle">
            <td style="height: 19px">
                <asp:Label ID="lblTitle" runat="server" CssClass="labeltopic">SMT产品不良明细查询</asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table class="query" height="100%" width="100%" id="Table2">
                    <tr>
                        ...
                        <td class="fieldValue">
                            <cc2:selectabletextbox id="txtConditionStepSequence" runat="server" Width="100px"
                                Type="stepsequence" CanKeyIn="true">
                            </cc2:selectabletextbox>
                        </td>
                        <td>
                        </td>
