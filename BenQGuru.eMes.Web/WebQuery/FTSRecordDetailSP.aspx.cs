...
namespace BenQGuru.eMES.Web.WebQuery
{
	...
	/// </summary>
	public partial class FTSRecordDetailSP : BasePage
	{
...
//			this.gridHelper.GridBind( this.pagerToolBar.PageIndex, this.pagerToolBar.PageSize );
		...
		{   
			this.gridHelper.AddColumn("a", "不良代码组",	null);
			this.gridHelper.AddColumn( "b", "不良代码",	null);
			this.gridHelper.AddColumn("c","不良原因",null);
			this.gridHelper.AddColumn( "d", "责任别",	null);
			this.gridHelper.AddColumn( "e", "解决方案",	null);
			this.gridHelper.AddColumn( "f", "不良位置",	null);
			this.gridHelper.AddColumn( "g", "故障元件",	null);
			this.gridHelper.AddColumn( "h", "更换元件",	null);
			this.gridHelper.AddColumn( "i", "维修站",	null);
			this.gridHelper.AddColumn( "j", "维修工",	null);
			this.gridHelper.AddColumn( "k", "维修日期",	null);
