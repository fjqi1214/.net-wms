...
namespace BenQGuru.eMES.Domain.Warehouse
{
    ...
    #region Invoices   //Amy 修改  表结构变化  @20160317
    /// <summary>
    /// TBLINVOICES
    /// </summary>
    [Serializable, TableMap("TBLINVOICES", "INVNO")]
    ...
    #region Invoicesdetail   //表结构变化，Amy修改  @20160317
    /// <summary>
    /// TBLINVOICESDETAIL
    /// </summary>
    [Serializable, TableMap("TBLINVOICESDETAIL", "INVNO,INVLINE")]
    ...
    public class Pick : BenQGuru.eMES.Common.Domain.DomainObject
    {
        ...
        ///<summary>
        ///状态:初始化，已下发，拣料完成，包装完成，OQC校验完成，箱单完成，已出库，取消
        ///</summary>
    ...
    #region Picktopo add by sam 新增关系
    /// <summary>
    /// TBLPICKTOPO
    /// </summary>
    ...
    #region Storloctrans add by sam 2016年3月25日
