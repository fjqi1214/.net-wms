...
{
    public class PCDriver : BaseDCTDriver, IDCTDriver
    {
        ...
        protected override void Clear()
        {
            ...
            (client as PCClient).ClearScreen();

            (client as PCClient).ClearRecievedData();
        ...
        protected override void Exit()
        {
            ...
            ((PCClient)client).ClearRecievedData();
        ...
        public override void DCTListen(object obj)
        {
            ...
            //循环处理用户输入
            while ((client as PCClient).ClientStatus == PCClientStatus.Connecting)
            {
                try
                {
                    client.Open();
