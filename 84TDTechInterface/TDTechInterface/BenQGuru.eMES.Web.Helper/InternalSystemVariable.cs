...
namespace BenQGuru.eMES.Web.Helper
{
    ...
    #region IQC Modify by jinger 2016-02-18
    ...
    public class SAP_STATUS : IInternalSystemVariable
    {
        ...
        public SAP_STATUS()
        {
            ...
            this._list.Add(SAP_WaitReceive);
            this._list.Add(SAP_ReceiveClose);
            this._list.Add(SAP_IQCClose);
            this._list.Add(SAP_OnLocation);
            this._list.Add(SAP_Close);
            this._list.Add(SAP_Cancel);
            this._list.Add(SAP_ReceiveRejection); 

        }
        public const string SAP_Release = "Release";   //初始化
        public const string SAP_WaitReceive = "WaitReceive";   //待收货
        public const string SAP_ReceiveClose = "ReceiveClose";   //初检完成
        public const string SAP_IQCClose = "IQCClose";   //IQC完成
        public const string SAP_OnLocation = "OnLocation";  //上架
        public const string SAP_Close = "Close";   //入库
        public const string SAP_Cancel = "Cancel";  //取消
