...
{
    /// <summary>
    /// BaseMPageForIQC 的摘要说明。
    /// </summary>
    public class BaseMPageForIQC : BaseMPageMinus
    {
        public BaseMPageForIQC()
            : base()
        {
        ...
        protected ExcelExporter excelExporter2 = null;
        ...
        protected virtual void InitOnPostBack()
        {
            ...
            if (this.buttonHelper.CmdExport2 != null && buttonHelper.CmdExport2.Attributes["bindclick"] == null)
            {
                this.buttonHelper.CmdExport2.ServerClick += new EventHandler(cmdExport2_Click);
            }
            #endregion
            ...
            {
                this.gridHelper2 = new GridHelperNew(this.gridWebGrid2, this.DtSource2, "pagerToolBar2", "pagerSizeSelector2");
            ...
            this.excelExporter2.LoadExportDataHandle = new LoadExportDataDelegate(LoadDataSource2);
            this.excelExporter2.FormatExportRecordHandle = new FormatExportRecordDelegate(FormatExportRecord2);
            this.excelExporter2.GetColumnHeaderTextHandle = new GetColumnHeaderTextDelegate(GetColumnHeaderText2);
            #endregion
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected virtual void cmdExport2_Click(object sender, System.EventArgs e)
        {
        ...
        /// </summary>
        /// <returns></returns>
        protected object[] LoadDataSource2()
        {
            return this.LoadDataSource2(1, int.MaxValue);
        }
        #endregion
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        protected virtual string[] FormatExportRecord2(object obj)
        {
            return null;
        }
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual string[] GetColumnHeaderText2()
        {
            return null;
        }
        #endregion
